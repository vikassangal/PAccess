...
namespace PatientAccess.Actions
{
    ...
    public class OnShortDemographicsForm : CompositeAction
    {
...
//            accountView.ActivateDemographicsTab();
           ...
           this.Context = "ShortDemographics";           
        }
        #endregion
        ...
        public OnShortDemographicsForm()
        {
        }
        public OnShortDemographicsForm(Account anAccount)
        {
