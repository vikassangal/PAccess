...
namespace PatientAccess.Actions
{
    ...
    public class OnInsuredFormForSecondaryInsurance : CompositeAction
    {
        ...
        public OnInsuredFormForSecondaryInsurance(Account anAccount)
        {
