...
namespace PatientAccess.Actions
{
    ...
    public class BenVerOnPayorDetailsFormForPrimaryInsurance : CompositeAction
    {
        ...
        public BenVerOnPayorDetailsFormForPrimaryInsurance()
        {
        }
        public BenVerOnPayorDetailsFormForPrimaryInsurance(Account anAccount)
        {
