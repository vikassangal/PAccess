...
namespace PatientAccess.Actions
{
    ...
    public class OnReferringNonStaffPhysicianForm : CompositeAction
    {
        ...
        {
            Context = "ReferringNonStaffPhysician"; 
        }
        #endregion
        ...
        public OnReferringNonStaffPhysicianForm()
        {
        }
        public OnReferringNonStaffPhysicianForm( Account anAccount )
        {
            Context = anAccount;
        }
