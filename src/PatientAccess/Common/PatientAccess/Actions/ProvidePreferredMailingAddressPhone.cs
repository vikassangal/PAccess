...
namespace PatientAccess.Actions
{
    ...
    public class ProvidePreferredMailingAddressPhone : LeafAction
    {
        ...
        public ProvidePreferredMailingAddressPhone()
        {
        }
        public ProvidePreferredMailingAddressPhone(Account anAccount)
        {
