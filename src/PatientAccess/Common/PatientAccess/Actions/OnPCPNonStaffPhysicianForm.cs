...
namespace PatientAccess.Actions
{
    ...
    public class OnPCPNonStaffPhysicianForm : CompositeAction
    {
        ...
        public OnPCPNonStaffPhysicianForm()
        {
        }
        public OnPCPNonStaffPhysicianForm( Account anAccount )
        {
            Context = anAccount;
        }
