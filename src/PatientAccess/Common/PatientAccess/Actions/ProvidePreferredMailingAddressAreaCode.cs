...
namespace PatientAccess.Actions
{
    ...
    public class ProvidePreferredMailingAddressAreaCode : LeafAction
    {
        ...
        public ProvidePreferredMailingAddressAreaCode()
        {
        }
        public ProvidePreferredMailingAddressAreaCode(Account anAccount)
        {
