...
namespace PatientAccess.Actions
{
    ...
    public class SecondaryAuthorizationExpDateToAdmitDate : LeafAction
    {
        ...
        {
            this.Context = "SecondaryAuthorization";
        }
        #endregion
        ...
        public SecondaryAuthorizationExpDateToAdmitDate()
        {
        }
        public SecondaryAuthorizationExpDateToAdmitDate(Account anAccount)
        {
