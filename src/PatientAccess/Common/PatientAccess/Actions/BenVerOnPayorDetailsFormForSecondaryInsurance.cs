...
namespace PatientAccess.Actions
{
    ...
    public class BenVerOnPayorDetailsFormForSecondaryInsurance : CompositeAction
    {
        ...
        public override void Execute()
        {
            ...
            accountView.ActivateInsuranceTab();
        ...
        public BenVerOnPayorDetailsFormForSecondaryInsurance()
        {
        }
        public BenVerOnPayorDetailsFormForSecondaryInsurance(Account anAccount)
        {
