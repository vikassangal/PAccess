...
namespace PatientAccess.Actions
{
    ...
    public class OnShortRegulatoryForm : CompositeAction
    {
        ...
        public OnShortRegulatoryForm()
        {
        }
        public OnShortRegulatoryForm(Account anAccount)
        {
