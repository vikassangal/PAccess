...
namespace PatientAccess.Actions
{
    ...
    public class OnOperatingNonStaffPhysicianForm : CompositeAction
    {
        ...
        {
            Context = "OperatingNonStaffPhysician";
        }
        #endregion
        ...
        public OnOperatingNonStaffPhysicianForm()
        {
        }
        public OnOperatingNonStaffPhysicianForm( Account anAccount )
        {
            Context = anAccount;
        }
