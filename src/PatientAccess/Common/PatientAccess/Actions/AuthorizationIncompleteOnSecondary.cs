...
namespace PatientAccess.Actions
{
    ...
    public class AuthorizationIncompleteOnSecondary : LeafAction
    {
        ...
        public AuthorizationIncompleteOnSecondary()
        {
        }
        public AuthorizationIncompleteOnSecondary(Account anAccount)
        {
