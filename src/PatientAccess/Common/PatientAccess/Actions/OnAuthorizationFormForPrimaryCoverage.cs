...
namespace PatientAccess.Actions
{
    ...
    public class OnAuthorizationFormForPrimaryCoverage : CompositeAction
    {
        ...
        public Account AccountContext
        {
            get
            {
                var iAccount = Context as IAccount;
        ...
        public OnAuthorizationFormForPrimaryCoverage()
        {
        }

        public OnAuthorizationFormForPrimaryCoverage(Account anAccount)
        {
            Context = anAccount;
        }
