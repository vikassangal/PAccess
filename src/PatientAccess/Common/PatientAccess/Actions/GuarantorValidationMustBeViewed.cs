...
namespace PatientAccess.Actions
{
    ...
    public class GuarantorValidationMustBeViewed : LeafAction
    {
        ...
        public GuarantorValidationMustBeViewed()
        {
        }
        public GuarantorValidationMustBeViewed(Account anAccount)
        {
