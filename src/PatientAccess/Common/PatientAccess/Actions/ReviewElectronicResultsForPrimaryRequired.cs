...
namespace PatientAccess.Actions
{
    ...
    public class ReviewElectronicResultsForPrimaryRequired : LeafAction
    {
        ...
        public ReviewElectronicResultsForPrimaryRequired()
        {
        }
        public ReviewElectronicResultsForPrimaryRequired(Account anAccount)
        {
