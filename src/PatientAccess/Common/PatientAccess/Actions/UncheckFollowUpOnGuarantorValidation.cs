...
namespace PatientAccess.Actions
{
    ...
    public class UncheckFollowUpOnGuarantorValidation : LeafAction
    {
        ...
        public UncheckFollowUpOnGuarantorValidation()
        {
        }
        public UncheckFollowUpOnGuarantorValidation(Account anAccount)
        {
