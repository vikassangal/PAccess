...
namespace PatientAccess.Actions
{
    ...
    public class SecondaryAuthorizationEffDateToAdmitDate : LeafAction
    {
        ...
        public SecondaryAuthorizationEffDateToAdmitDate()
        {
        }
        public SecondaryAuthorizationEffDateToAdmitDate(Account anAccount)
        {
