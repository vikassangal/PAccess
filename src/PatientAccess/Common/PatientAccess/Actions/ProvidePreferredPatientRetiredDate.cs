...
namespace PatientAccess.Actions
{
    ...
    public class ProvidePreferredPatientRetiredDate : LeafAction
    {
        ...
        public ProvidePreferredPatientRetiredDate()
        {
        }
        public ProvidePreferredPatientRetiredDate(Account anAccount)
        {
