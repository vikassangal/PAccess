...
namespace PatientAccess.Actions
{
    ...
    public class OnPayorDetailsFormForSecondaryPayor : CompositeAction
    {
        ...
        public OnPayorDetailsFormForSecondaryPayor()
        {
        }
        public OnPayorDetailsFormForSecondaryPayor(Account anAccount)
        {
