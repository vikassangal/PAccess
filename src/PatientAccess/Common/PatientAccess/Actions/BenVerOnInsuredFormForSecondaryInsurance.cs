...
namespace PatientAccess.Actions
{
    ...
    public class BenVerOnInsuredFormForSecondaryInsurance : CompositeAction
    {
        ...
        public BenVerOnInsuredFormForSecondaryInsurance()
        {
        }
        public BenVerOnInsuredFormForSecondaryInsurance(Account anAccount)
        {
