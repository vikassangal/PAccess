...
namespace PatientAccess.Actions
{
    ...
    public class OnAdmittingNonStaffPhysicianForm : CompositeAction
    {
        ...
        {
            Context = "AdmittingNonStaffPhysician";
        }
        #endregion
        ...
        public OnAdmittingNonStaffPhysicianForm()
        {
        }
        public OnAdmittingNonStaffPhysicianForm( Account anAccount )
        {
            Context = anAccount;
        }
