...
namespace PatientAccess.Actions
{
    ...
    public class OnAuthorizationFormForSecondaryCoverage : CompositeAction
    {
        ...
        {
            Context = "SecondaryAuthorization";
        }
        ...
        public OnAuthorizationFormForSecondaryCoverage(Account anAccount)
        {
            Context = anAccount;
        }
