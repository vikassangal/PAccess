...
namespace PatientAccess.Actions
{
    ...
    public class BenefitsVerificationInCompleteForSecondary : LeafAction
    {
        ...
        public BenefitsVerificationInCompleteForSecondary()
        {
        }
        public BenefitsVerificationInCompleteForSecondary(Account anAccount)
        {
