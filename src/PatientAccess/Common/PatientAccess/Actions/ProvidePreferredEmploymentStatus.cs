...
namespace PatientAccess.Actions
{
    ...
    public class ProvidePreferredEmploymentStatus : LeafAction
    {
        ...
        public ProvidePreferredEmploymentStatus()
        {
        }
        public ProvidePreferredEmploymentStatus(Account anAccount)
        {
