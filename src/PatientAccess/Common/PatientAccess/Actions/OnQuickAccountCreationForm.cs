...
namespace PatientAccess.Actions
{
    ...
    public class OnQuickAccountCreationForm : CompositeAction
    {
        ...
        public override void Execute()
        {
            ...
            this.Context = "QuickAccountCreation";  
        }
        #endregion
        ...
        public OnQuickAccountCreationForm()
        {
        }
        public OnQuickAccountCreationForm(Account anAccount)
        {
