...
namespace PatientAccess.Actions
{
    ...
    public class ProvidePreferredEmployerPhoneAreaCode : LeafAction
    {
        ...
        public ProvidePreferredEmployerPhoneAreaCode()
        {
        }
        public ProvidePreferredEmployerPhoneAreaCode(Account anAccount)
        {
