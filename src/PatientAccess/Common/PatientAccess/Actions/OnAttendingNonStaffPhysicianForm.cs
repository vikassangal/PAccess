...
namespace PatientAccess.Actions
{
    ...
    public class OnAttendingNonStaffPhysicianForm : CompositeAction
    {
        ...
        {
            Context = "AttendingNonStaffPhysician";
        }
        #endregion
        ...
        public OnAttendingNonStaffPhysicianForm()
        {
        }
        public OnAttendingNonStaffPhysicianForm( Account anAccount )
        {
            Context = anAccount;
        }
