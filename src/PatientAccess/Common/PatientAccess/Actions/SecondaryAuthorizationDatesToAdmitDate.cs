...
namespace PatientAccess.Actions
{
    ...
    public class SecondaryAuthorizationDatesToAdmitDate : LeafAction
    {
        ...
        public SecondaryAuthorizationDatesToAdmitDate()
        {
        }
        public SecondaryAuthorizationDatesToAdmitDate(Account anAccount)
        {
