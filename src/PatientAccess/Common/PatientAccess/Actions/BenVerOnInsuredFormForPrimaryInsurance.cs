...
namespace PatientAccess.Actions
{
    ...
    public class BenVerOnInsuredFormForPrimaryInsurance : CompositeAction
    {
        ...
        public BenVerOnInsuredFormForPrimaryInsurance()
        {
        }
        public BenVerOnInsuredFormForPrimaryInsurance(Account anAccount)
        {
