...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class MailingAddressAreaCodeRequired : PostRegRule
    {
        #region Event Handlers
        public event EventHandler MailingAddressAreaCodeRequiredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            MailingAddressAreaCodeRequiredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.MailingAddressAreaCodeRequiredEvent = null;
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            {
                if ( this.FireEvents && MailingAddressAreaCodeRequiredEvent != null )
                {
                    MailingAddressAreaCodeRequiredEvent( this, null );
                }
                return false;
            }
            else
        ...
        public MailingAddressAreaCodeRequired()
        {
        }
        #endregion
