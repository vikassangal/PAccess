...
{
    /// <summary>
    /// Summary description for PersonSSNRequired.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class PersonSSNRequired : LeafRule
    {
        #region Event Handlers
        public event EventHandler PersonSSNRequiredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            PersonSSNRequiredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.PersonSSNRequiredEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            else
            {
                ...
                if( this.FireEvents && PersonSSNRequiredEvent != null )
                {
                    PersonSSNRequiredEvent( this, new PropertyChangedArgs( this.AssociatedControl ) );
                }
                return false;
            }
        }
