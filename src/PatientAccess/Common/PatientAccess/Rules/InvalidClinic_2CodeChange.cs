...
{
    /// <summary>
    /// Summary description for Clinic_2Required.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_2CodeChange : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_2CodeChangeEvent;
        ...
        {
            this.InvalidClinic_2CodeChangeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_2CodeChangeEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo(object context)
        {
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                HospitalClinic clinic =  (HospitalClinic)account.Clinics[1] ;
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_2CodeChangeEvent != null )
                            {
                                this.InvalidClinic_2CodeChangeEvent(this, null);
                            }
        ...
        public InvalidClinic_2CodeChange()
        {
        }
