...
{
    /// <summary>
    /// Summary description for ContactAreaCodeRequired.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class ContactAreaCodeRequired : LeafRule
    {
        #region Event Handlers
        public event EventHandler ContactAreaCodeRequiredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            ContactAreaCodeRequiredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.ContactAreaCodeRequiredEvent = null;
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            {
                if( this.FireEvents && ContactAreaCodeRequiredEvent != null )
                {
                    ContactAreaCodeRequiredEvent( this, null );
                }
                return false;
            }
        }
        ...
        public ContactAreaCodeRequired()
        {
        }
        #endregion
