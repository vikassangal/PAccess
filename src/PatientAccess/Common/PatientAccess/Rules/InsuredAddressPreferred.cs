...
{
    /// <summary>
    /// Summary description for InsuredAddressPreferred.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class InsuredAddressPreferred : LeafRule
    {
        #region Event Handlers
        public event EventHandler InsuredAddressPreferredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            InsuredAddressPreferredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InsuredAddressPreferredEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            {
                if( this.FireEvents && InsuredAddressPreferredEvent != null )
                {
                    InsuredAddressPreferredEvent( this, new PropertyChangedArgs( this.AssociatedControl ) );
                }
                return false;
            }
        }
        ...
        public InsuredAddressPreferred()
        {
        }
        #endregion
