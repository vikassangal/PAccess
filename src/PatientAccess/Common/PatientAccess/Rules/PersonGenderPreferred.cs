...
{
    /// <summary>
    /// Summary description for PersonGenderPreferred.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class PersonGenderPreferred : LeafRule
    {
        #region Event Handlers
        public event EventHandler PersonGenderPreferredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            PersonGenderPreferredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.PersonGenderPreferredEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            else
            {
                ...
                if( this.FireEvents && PersonGenderPreferredEvent != null )
                {
                    PersonGenderPreferredEvent( this, new PropertyChangedArgs( this.AssociatedControl ) );
                }
                return false;
            }
        }
