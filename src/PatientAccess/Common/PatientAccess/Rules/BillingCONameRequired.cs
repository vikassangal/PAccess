...
{
    /// <summary>
    /// Summary description for BillingCONameRequired.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class BillingCONameRequired : LeafRule
    {
        #region Event Handlers
        public event EventHandler BillingCONameRequiredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            BillingCONameRequiredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.BillingCONameRequiredEvent = null;  
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            {
                if( this.FireEvents && BillingCONameRequiredEvent != null )
                {
                    BillingCONameRequiredEvent( this, null );
                }
                return false;
            }
            else
