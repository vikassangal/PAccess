...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_1Code : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_1CodeEvent;
        ...
        {
            this.InvalidClinic_1CodeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_1CodeEvent = null;   
        }
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                if (clinic != null)
                {
                       ...
                       )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_1CodeEvent != null )
                            {
                                this.InvalidClinic_1CodeEvent(this, null);
                            }
