...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_1CodeChange : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_1CodeChangeEvent;
        ...
        {
            this.InvalidClinic_1CodeChangeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_1CodeChangeEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo(object context)
        {
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                HospitalClinic clinic =  (HospitalClinic)account.Clinics[0] ;
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_1CodeChangeEvent != null )
                            {
                                this.InvalidClinic_1CodeChangeEvent(this, null);
                            }
        ...
        public InvalidClinic_1CodeChange()
        {
        }
