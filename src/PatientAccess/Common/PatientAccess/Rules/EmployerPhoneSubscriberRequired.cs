...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class EmployerPhoneSubscriberRequired : PostRegRule
    {
        #region Event Handlers
        
        public event EventHandler EmployerPhoneSubscriberRequiredEvent;
        ...
        public override bool CanBeAppliedTo( object context )
        {
                ...
                {            
                    ...
                    else
                    {
                        if( employerContactPoint == null
                            ...
                            || employerContactPoint.PhoneNumber.Number.Equals( String.Empty ) ) 
                        {                    
                            result = false;
                        }
                    }
            ...
            if( !result )
            {
                if( this.FireEvents && EmployerPhoneSubscriberRequiredEvent != null )
                {
                    EmployerPhoneSubscriberRequiredEvent( this, null );
                }
            }
        ...
        public EmployerPhoneSubscriberRequired()
        {
        }
        #endregion
