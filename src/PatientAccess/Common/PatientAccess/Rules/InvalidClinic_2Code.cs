...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_2Code : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_2CodeEvent;
        ...
        {
            this.InvalidClinic_2CodeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_2CodeEvent = null;   
        }
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_2CodeEvent != null )
                            {
                                this.InvalidClinic_2CodeEvent(this, null);
                            }
