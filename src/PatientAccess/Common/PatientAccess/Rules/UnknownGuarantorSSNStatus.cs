...
{
    //TODO: Create XML summary comment for UnknownGuarantorSSNStatus
    [Serializable]
    [UsedImplicitly]
    public class UnknownGuarantorSSNStatus : LeafRule
    {
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            SocialSecurityNumber ssnNumber  =  anAccount.Guarantor.SocialSecurityNumber;
        ...
        public UnknownGuarantorSSNStatus()
        {
        }
        #endregion
