...
{
    /// <summary>
    /// Summary description for COB Received Required
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class COBReceivedRequired : LeafRule
    {
        ...
        public override bool CanBeAppliedTo(object context)
        {
            ...
            if ((COBReceivedAndIMFMReceivedFeatureManager.IsCOBReceivedEnabledForAccount(anAccount))
                && String.IsNullOrEmpty(anAccount.COBReceived.Code.Trim()))
            {
