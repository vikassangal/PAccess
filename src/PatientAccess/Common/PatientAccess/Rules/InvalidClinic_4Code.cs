...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_4Code : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_4CodeEvent;
        ...
        {
            this.InvalidClinic_4CodeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_4CodeEvent = null;   
        }
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_4CodeEvent != null )
                            {
                                this.InvalidClinic_4CodeEvent(this, null);
                            }
