...
{
    /// <summary>
    /// Summary description for Clinic_3Required.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_3CodeChange : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_3CodeChangeEvent;
        ...
        {
            this.InvalidClinic_3CodeChangeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_3CodeChangeEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo(object context)
        {
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                HospitalClinic clinic =  (HospitalClinic)account.Clinics[2] ;
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_3CodeChangeEvent != null )
                            {
                                this.InvalidClinic_3CodeChangeEvent(this, null);
                            }
        ...
        public InvalidClinic_3CodeChange()
        {
        }
