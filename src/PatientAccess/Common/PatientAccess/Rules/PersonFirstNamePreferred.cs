...
{
    /// <summary>
    /// Summary description for PersonFirstNamePreferred.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class PersonFirstNamePreferred : LeafRule
    {
        #region Event Handlers
        public event EventHandler PersonFirstNamePreferredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            PersonFirstNamePreferredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.PersonFirstNamePreferredEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            else
            {
                ...
                if( this.FireEvents && PersonFirstNamePreferredEvent != null )
                {
                    PersonFirstNamePreferredEvent( this, new PropertyChangedArgs( this.AssociatedControl ) );
                }
                return false;
            }
        }
        ...
        public PersonFirstNamePreferred()
        {
        }
        #endregion
