...
{
    /// <summary>
    /// Summary description for TimeCannotBeInFutureTime.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class TimeCannotBeInFutureTime : LeafRule
    {
        ...
        {            
            ...
            if( DateToEvaluate.Date <= facilityDateTime.Date &&
                DateToEvaluate > facilityDateTime )
            {                                                       
                return false;
            }
        ...
        public TimeCannotBeInFutureTime()
        {
        }
        #endregion
        ...
        private DateTime    facDateTime = DateTime.MinValue;
