...
{
    /// <summary>
    /// Summary description for EmploymentPhoneNumberPreferred.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class EmploymentPhoneNumberPreferred : LeafRule
    {
        #region Event Handlers
        public event EventHandler EmploymentPhoneNumberPreferredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            EmploymentPhoneNumberPreferredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.EmploymentPhoneNumberPreferredEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            else
            {
                ...
                {
                    if( this.FireEvents && EmploymentPhoneNumberPreferredEvent != null )
                    {
                        EmploymentPhoneNumberPreferredEvent( this, new PropertyChangedArgs( this.AssociatedControl ) );
                    }
        ...
        public EmploymentPhoneNumberPreferred()
        {
        }
        #endregion
