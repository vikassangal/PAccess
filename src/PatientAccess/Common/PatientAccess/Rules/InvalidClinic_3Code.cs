...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_3Code : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_3CodeEvent;
        ...
        {
            this.InvalidClinic_3CodeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_3CodeEvent = null;   
        }
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_3CodeEvent != null )
                            {
                                this.InvalidClinic_3CodeEvent(this, null);
                            }
