...
{
    /// <summary>
    /// Summary description for Clinic_5Required.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_5CodeChange : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_5CodeChangeEvent;
        ...
        {
            this.InvalidClinic_5CodeChangeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_5CodeChangeEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo(object context)
        {
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                HospitalClinic clinic =  (HospitalClinic)account.Clinics[4] ;
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_5CodeChangeEvent != null )
                            {
                                this.InvalidClinic_5CodeChangeEvent(this, null);
                            }
        ...
        public InvalidClinic_5CodeChange()
        {
        }
