...
{
    /// <summary>
    /// Summary description for InvalidRace2Code.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class InvalidRace2Code : LeafRule
    {
        #region Events
        ...
        public override bool CanBeAppliedTo(object context)
        {
            ...
            if (account.Patient!=null && 
                (!account.Patient.IsRace2Valid(account) ||
                !account.Patient.IsNationality2Valid(account)))
            {
