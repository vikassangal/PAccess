...
namespace PatientAccess.Rules
{
    ...
    [Serializable]
    [UsedImplicitly]
    public class InvalidClinic_5Code : LeafRule
    {
        #region Events
        
        public event EventHandler InvalidClinic_5CodeEvent;
        ...
        {
            this.InvalidClinic_5CodeEvent += eventHandler;
            return true;
        }
        ...
        {
            this.InvalidClinic_5CodeEvent = null;   
        }
                ...
                &&  (account.Clinics.Count >0  ))
            {
                ...
                if (clinic != null)
                {
                        ...
                        )
                    {
                        ...
                        {
                            if( this.FireEvents && InvalidClinic_5CodeEvent != null )
                            {
                                this.InvalidClinic_5CodeEvent(this, null);
                            }
