...
{
    /// <summary>
    /// Summary description for PersonEmploymentStatusPreferred.
    /// </summary>
    [Serializable]
    [UsedImplicitly]
    public class PersonEmploymentStatusPreferred : LeafRule
    {
        #region Event Handlers
        public event EventHandler PersonEmploymentStatusPreferredEvent;
        #endregion

        #region Methods
        public override bool RegisterHandler( EventHandler eventHandler )
        {
            PersonEmploymentStatusPreferredEvent += eventHandler;
            return true;
        }
        ...
        {
            this.PersonEmploymentStatusPreferredEvent = null;   
        }
        ...
        public override bool CanBeAppliedTo( object context )
        {
            ...
            else
            {
                ...
                if( this.FireEvents && PersonEmploymentStatusPreferredEvent != null )
                {
                    PersonEmploymentStatusPreferredEvent( this, new PropertyChangedArgs( this.AssociatedControl ) );
                }
        ...
        public PersonEmploymentStatusPreferred()
        {
        }
        #endregion
