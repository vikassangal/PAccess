...
namespace Tests.Unit.PatientAccess.Domain
{
    [TestFixture]
    [Category( "Fast" )]
    public class PreAdmitNewbornWithOfflineActivityTests : ActivityTests
    {
        #region Constants
        #endregion
        ...
        {
            this.UnitUnderTest = new PreAdmitNewbornWithOfflineActivity();
        }
        ...
        public void TestDescriptions()
        {
            ...
            // expected
            string lDescription = "Enter Pre-Admit Newborn Registration with Offline Account Number...";
            string lContextDescription = "Enter Pre-Admit Newborn Registration with Offline Account Number...";
