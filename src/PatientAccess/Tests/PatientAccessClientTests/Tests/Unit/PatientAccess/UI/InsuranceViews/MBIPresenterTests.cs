    ...
    public class MBIPresenterTests
    {
        ...
        public void TestCommercialCoverage_ValidateNumber()
        {
            ...
            var presenter = new MBIPresenter(mbiView, new MessageBoxAdapter(),
                coverage, RuleEngine);
            mbiView.MBINumber = VALID_MBINUMBER;
            var validMBI = presenter.ValidateMBI();
        ...
        private const string VALID_MBINUMBER = "1EG4TE5MK64";
