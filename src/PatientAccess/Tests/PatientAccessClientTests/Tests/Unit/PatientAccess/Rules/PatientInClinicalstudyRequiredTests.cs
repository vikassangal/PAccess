...
{
    /// <summary>
    /// Summary description for PatientInClinicalstudyRequiredTests
    /// </summary>
    [TestFixture]
    [Category( "Fast" )]
    public class PatientInClinicalstudyRequiredTests
    {
        #region Test Methods
        [Test]
        public void TestCanBeAppliedToWithInvalidContextType_ShouldReturnTrue()
        {
            PatientInClinicalstudyRequired ruleUnderTest = new PatientInClinicalstudyRequired();
        ...
        {
            var ruleUnderTest = new PatientInClinicalstudyRequired();
