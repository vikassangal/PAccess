...
{
    /// <summary>
    /// Summary description for NewbornTransactionCoordinatorTests.
    /// </summary>

    //TODO: Create XML summary comment for NewbornTransactionCoordinatorTests
    [TestFixture()]
    public class NewbornTransactionCoordinatorTests
    {
        #region Constants
        ...
        #region SetUp and TearDown NewbornTransactionCoordinatorTests
        [TestFixtureSetUp()]
        public static void SetUpNewbornTransactionCoordinatorTests()
        {
        ...
        [TestFixtureTearDown()]
        public static void TearDownNewbornTransactionCoordinatorTests()
        {
        }
        #endregion
        ...
        public void TestTransactionCoordinatorFor()
        {
            Activity currentActivity =
                new AdmitNewbornActivity();
            TransactionCoordinator newbornTransactionCoordinator =
                TransactionCoordinator.TransactionCoordinatorFor( currentActivity );
            Assert.IsNotNull( newbornTransactionCoordinator );
            Assert.AreEqual( typeof( NewbornTransactionCoordinator ),
                             newbornTransactionCoordinator.GetType() );
        }
        ...
        public void TestGetInsertStrategy()
        {
                ...
                NewbornTransactionCoordinator newbornCoordinator =
                    new NewbornTransactionCoordinator();
                newbornCoordinator.NumberOfInsurances = 0;
                newbornCoordinator.NumberOfNonInsurances = 0;
                newbornCoordinator.NumberOfOtherRecs = 0;
                newbornCoordinator.Account = account;
                newbornCoordinator.AppUser = account.Activity.AppUser;

                SqlBuilderStrategy[] strategy = newbornCoordinator.InsertStrategies;
