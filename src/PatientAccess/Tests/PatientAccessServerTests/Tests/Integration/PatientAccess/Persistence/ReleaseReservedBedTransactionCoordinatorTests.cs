...
{
    [TestFixture()]
    public class ReleaseReservedBedTransactionCoordinatorTests
    {
        #region Constants
        ...
        #region SetUp and TearDown ReleaseReservedBedTransactionCoordinatorTests
        [TestFixtureSetUp()]
        public static void SetUpReleaseReservedBedTransactionCoordinatorTests()
        {
        ...
        [TestFixtureTearDown()]
        public static void TearDownReleaseReservedBedTransactionCoordinatorTests()
        {
        }
        #endregion
        ...
        public void TestTransactionCoordinatorFor()
        {
            Activity currentActivity = 
                new ReleaseReservedBedActivity();
            TransactionCoordinator reservedBedTransactionCoordinator =
                TransactionCoordinator.TransactionCoordinatorFor( currentActivity );
            Assert.IsNotNull( reservedBedTransactionCoordinator );
            Assert.AreEqual( typeof( ReleaseReservedBedTransactionCoordinator ), 
                             reservedBedTransactionCoordinator.GetType() );
        }
        ...
        public void TestGetInsertStrategy()
        {
                ...
                account.Activity = new ReleaseReservedBedActivity();

                ReleaseReservedBedTransactionCoordinator ReleaseReservedBed =
                    new ReleaseReservedBedTransactionCoordinator();
                ReleaseReservedBed.NumberOfInsurances = 0;
                ReleaseReservedBed.NumberOfNonInsurances = 0;
                ReleaseReservedBed.NumberOfOtherRecs = 0;
                ReleaseReservedBed.Account = account;
                ReleaseReservedBed.AppUser = account.Activity.AppUser;

                SqlBuilderStrategy[] strategy = ReleaseReservedBed.InsertStrategies;
        }
        #endregion
