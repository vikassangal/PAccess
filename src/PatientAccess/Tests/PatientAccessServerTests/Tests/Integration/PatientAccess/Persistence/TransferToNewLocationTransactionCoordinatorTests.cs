...
{
    [TestFixture()]
    public class TransferToNewLocationTransactionCoordinatorTests
    {
        #region Constants
        ...
        #region SetUp and TearDown TransferToNewLocationTransactionCoordinatorTests
        [TestFixtureSetUp()]
        public static void SetUpTransferToNewLocationTransactionCoordinatorTests()
        {
        ...
        [TestFixtureTearDown()]
        public static void TearDownTransferToNewLocationTransactionCoordinatorTests()
        {
        }
        #endregion
        ...
        public void TestTransactionCoordinatorFor()
        {
            Activity currentActivity = 
                new TransferActivity();
            TransactionCoordinator transferToNewLocationTransactionCoordinator =
                TransactionCoordinator.TransactionCoordinatorFor( currentActivity );
            Assert.IsNotNull( transferToNewLocationTransactionCoordinator );
            Assert.AreEqual( typeof( TransferToNewLocationTransactionCoordinator ), 
                             transferToNewLocationTransactionCoordinator.GetType() );
        }
        ...
        public void TestGetInsertStrategy()
        {
                ...
                TransferToNewLocationTransactionCoordinator transferToNewCoordinator =
                    new TransferToNewLocationTransactionCoordinator();
                transferToNewCoordinator.NumberOfInsurances = 0;
                transferToNewCoordinator.NumberOfNonInsurances = 0;
                transferToNewCoordinator.NumberOfOtherRecs = 0;
                transferToNewCoordinator.Account = account;
                transferToNewCoordinator.AppUser = account.Activity.AppUser;

                SqlBuilderStrategy[] strategy = transferToNewCoordinator.InsertStrategies;
