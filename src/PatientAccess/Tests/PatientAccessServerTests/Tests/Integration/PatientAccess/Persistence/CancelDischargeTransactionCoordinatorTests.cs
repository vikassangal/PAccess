...
{
    [TestFixture()]
    public class CancelDischargeTransactionCoordinatorTests
    {
        #region Constants
        ...
        private const string PATIENT_F_NAME = "TESTTRANSFER", PATIENT_L_NAME = "TEST";
        ...
        #region SetUp and TearDown CancelDischargeTransactionCoordinatorTests
        [TestFixtureSetUp()]
        public static void SetUpCancelDischargeTransactionCoordinatorTests()
        {
        ...
        [TestFixtureTearDown()]
        public static void TearDownCancelDischargeTransactionCoordinatorTests()
        {
        }
        #endregion
        ...
        public void TestTransactionCoordinatorFor()
        {
            Activity currentActivity = 
                new CancelInpatientDischargeActivity();
            ...
            Assert.AreEqual( typeof( CancelDischargeTransactionCoordinator ), 
        ...
        public void TestGetInsertStrategy()
        {
            ...
            account.Activity = new CancelInpatientDischargeActivity();

            CancelDischargeTransactionCoordinator cancelCoordinator =
                new CancelDischargeTransactionCoordinator();
            cancelCoordinator.NumberOfInsurances = 0;
            cancelCoordinator.NumberOfNonInsurances = 0;
            cancelCoordinator.NumberOfOtherRecs = 0;
            cancelCoordinator.Account = account;
            cancelCoordinator.AppUser = account.Activity.AppUser;

            SqlBuilderStrategy[] strategy = cancelCoordinator.InsertStrategies;

            Assert.IsTrue( true, "Return of insert strategies for cancel discharge succeeded" );
        }
