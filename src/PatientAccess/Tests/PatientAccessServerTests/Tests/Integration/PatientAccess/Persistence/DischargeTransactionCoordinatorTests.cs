...
{
    [TestFixture()]
    public class DischargeTransactionCoordinatorTests
    {
        #region Constants
        ...
        #region SetUp and TearDown DischargeTransactionCoordinatorTests
        [TestFixtureSetUp()]
        public static void SetUpDischargeTransactionCoordinatorTests()
        {
        ...
        [TestFixtureTearDown()]
        public static void TearDownDischargeTransactionCoordinatorTests()
        {
        }
        #endregion
        ...
        public void TestTransactionCoordinatorFor()
        {
            ...
            TransactionCoordinator dischargeTransactionCoordinator =
                TransactionCoordinator.TransactionCoordinatorFor( currentActivity );
            Assert.IsNotNull( dischargeTransactionCoordinator );
            Assert.AreEqual( typeof( DischargeTransactionCoordinator ), 
                             dischargeTransactionCoordinator.GetType() );
        ...
        public void TestGetInsertStrategy()
        {
                ...
                DischargeTransactionCoordinator dischargeCoordinator =
                    new DischargeTransactionCoordinator();
                dischargeCoordinator.NumberOfInsurances = 0;
                dischargeCoordinator.NumberOfNonInsurances = 0;
                dischargeCoordinator.NumberOfOtherRecs = 0;
                dischargeCoordinator.Account = account;
                dischargeCoordinator.AppUser = account.Activity.AppUser;

                SqlBuilderStrategy[] strategy = dischargeCoordinator.InsertStrategies;
