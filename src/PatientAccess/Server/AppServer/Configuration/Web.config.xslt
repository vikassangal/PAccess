...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:date="http://exslt.org/dates-and-times" extension-element-prefixes="date">
  ...
  <xsl:variable name="LongCacheInterval" 
                select="/Settings/ServerSettings/CacheTimeout/Long[contains(@Environment,$Environment)]/text()"/>
  <xsl:variable name="MediumCacheInterval" 
                select="/Settings/ServerSettings/CacheTimeout/Medium[contains(@Environment,$Environment)]/text()" />
  <xsl:variable name="ShortCacheInterval" 
                select="/Settings/ServerSettings/CacheTimeout/Short[contains(@Environment,$Environment)]/text()" />
  ...
  <xsl:template match="/">
    <configuration>
      ...
      <appSettings>
        ...
        <add key="PatientAccess.UI.DocumentImagingViews.ScanHTML5Url" value="{/Settings/ExternalSystems/DocumentImaging/ScanHTML5Url[contains(@Environment,$Environment)]/text()}" />
        ...
        <add key="PatientAccess.UI.DocumentImagingViews.ViewHTML5Url" value="{/Settings/ExternalSystems/DocumentImaging/ViewHTML5Url[contains(@Environment,$Environment)]/text()}" />
        ...
        <add key="VIWebGUID" value="{/Settings/ExternalSystems/DocumentImaging/Guid[contains(@Environment,$Environment)]/text()}" />
        <add key="VIWebAppKey" value="{/Settings/ExternalSystems/DocumentImaging/Key[contains(@Environment,$Environment)]/text()}" />
        <add key="LocalVIwebUrl" value="{/Settings/ServerSettings/AppUpdater/LocalVIwebUrl[contains(@Environment,$Environment)]/text()}" />
        ...
        <add key="NumberOfDaysAfterAdmitDateToKeepOnlineReregistrationSubmissions" value="5" />
        <add key="EMPISERVICE_USERNAME" value="{/Settings/ExternalSystems/Empi/EMPISERVICE_USERNAME[contains(@Environment,$Environment)]/text()}"/>
        <add key="EMPISERVICE_PASSWORD" value="{/Settings/ExternalSystems/Empi/EMPISERVICE_PASSWORD[contains(@Environment,$Environment)]/text()}"/>        
        ...
        <add key="OKTA_ROLE_LIMIT" value="{/Settings/ExternalSystems/OKTA/OKTA_ROLE_LIMIT[contains(@Environment,$Environment)]/text()}"/>  
		<add key="DOFRApiUrl" value="{/Settings/ExternalSystems/DOFR/ApiUrl[contains(@Environment,$Environment)]/text()}"/>
		<add key="DOFRApiKey" value="{/Settings/ExternalSystems/DOFR/ApiKey[contains(@Environment,$Environment)]/text()}"/>
		<add key="DOFRUseTLS12" value="{/Settings/ExternalSystems/DOFR/UseTLS12[contains(@Environment,$Environment)]/text()}"/>
        ...
        <add key="DOFRAPITimeout" value="{/Settings/ExternalSystems/DOFR/APITimeout[contains(@Environment,$Environment)]/text()}"/>
      </appSettings>
      <system.runtime.remoting>
        <application>
          <service>
            ...
            <!-- AlternateCareFacilityPBARBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.AlternateCareFacilityPbarBroker, PatientAccess.AppServer" objectUri="AlternateCareFacilityPbarBroker.rem" />
            <!-- LeftOrStayedBroker -->
            ...
            <!-- DialysisCenterPbarBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.DialysisCenterPbarBroker, PatientAccess.AppServer" objectUri="DialysisCenterPbarBroker.rem" />
            <!-- CellPhoneConsentBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.CellPhoneConsentBroker, PatientAccess.AppServer" objectUri="CellPhoneConsentBroker.rem" />
            <!-- PriorVisitBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.PriorVisitBroker, PatientAccess.AppServer" objectUri="PriorVisitBroker.rem" />
            <!-- EMPIBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.EMPIBroker, PatientAccess.AppServer" objectUri="EMPIBroker.rem" />
            <!-- SuffixBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.SuffixBroker, PatientAccess.AppServer" objectUri="SuffixBroker.rem" />
            <!-- OKTAUserBroker -->
            ...
            <!-- InterFacilityTransferPBARBroker -->
            <wellknown mode="SingleCall" type="PatientAccess.Persistence.InterFacilityTransferPBARBroker, PatientAccess.AppServer" objectUri="InterFacilityTransferPBARBroker.rem" />
			  <!-- DOFRInitiateBroker -->
      ...
      <system.web>
        ...
        -->
        <compilation defaultLanguage="c#" debug="{/Settings/ServerSettings/AppUpdater/CompilationDebug[contains(@Environment,$Environment)]/text()}" />
      ...
      <system.serviceModel>
        <bindings>
          <basicHttpBinding>
            ...
            <!--<binding name="IdentityHubSoapBinding"  maxReceivedMessageSize="2147483647" sendTimeout="00:00:05" receiveTimeout="00:00:05"/>-->
            <binding name="IdentityHubSoapBinding" maxReceivedMessageSize="2147483647"  sendTimeout="00:00:05" receiveTimeout="00:00:05" >
