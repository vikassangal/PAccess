...
namespace PatientAccess.Jobs
{
    ...
    /// </summary>
    [UsedImplicitly]
    class PurgeNewEmployerAddressesJob : DB2Job
    {
        /// <summary>
        ...
        protected override string CommandText
        {
            get
            {
                return "DELETE FROM EMPLOYERADDRESSFORAPPROVAL WHERE DAYS(DATE( CURRENT TIMESTAMP )) - DAYS(DATE( DATETIMEENTERED )) >= @MaxDays";
            }
        }
