...
{
    /// <summary> 
    /// Encrypts a a string when it's saved
    /// and decrypts it when it gets it from the database.
    /// Modified from the implementation provided at
    ...
    {
        private readonly IEncryptor encryptor = new AesEncryptor();
