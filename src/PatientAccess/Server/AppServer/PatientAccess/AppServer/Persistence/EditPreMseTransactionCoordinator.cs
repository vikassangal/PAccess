...
{
	/// <summary>
	/// Summary description for EditPreMseCoordinator.
	/// </summary>
	//TODO: Create XML summary comment for EditPreMseCoordinator
    [Serializable]
    internal class EditPreMseTransactionCoordinator : TransactionCoordinator 
    {
        ...
        public override SqlBuilderStrategy[] InsertStrategies
        {
            get
            {
                ...
                for( int i = 1; i <= Account.Insurance.Coverages.Count; i++ )
                {
                    ...
                    strategy.PriorityCode = i.ToString();
        ...
        public new void Add( string aSqlStatement )
        {
        ...
        public EditPreMseTransactionCoordinator()
        {
        }
        public EditPreMseTransactionCoordinator( Account anAccount )
            : base( anAccount )
        {
            this.NumberOfNonInsurances = NUMBER_OF_NON_INSURANCE_TRANSACTIONS;
        }
        public EditPreMseTransactionCoordinator(User user) 
        : base( user )
        {
            this.NumberOfNonInsurances = NUMBER_OF_NON_INSURANCE_TRANSACTIONS;
        } 
