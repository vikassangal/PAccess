...
namespace PatientAccess.Persistence
{
    ...
    /// </summary>
    [Serializable]
    internal class EditDischargeInfoTransactionCoordinator : TransactionCoordinator
    {
        ...
        public override SqlBuilderStrategy[] InsertStrategies
        {
            get
            {
                ...
                strategy.TransactionFileId = EDIT_DISCHARGE_TRANSACTION_ID;
        ...
        public EditDischargeInfoTransactionCoordinator()
        {
            this.NumberOfNonInsurances = NUMBER_OF_NON_INSURANCE_TRANSACTIONS;
        }
        public EditDischargeInfoTransactionCoordinator(User user) 
            : base( user )
        {
            this.NumberOfNonInsurances = NUMBER_OF_NON_INSURANCE_TRANSACTIONS;
        } 
        ...
        private const string EDIT_DISCHARGE_TRANSACTION_ID           = "DI";
