...
{
    /// <summary>
    /// Summary description for CFDBLookupService
    /// </summary>
    [Serializable]
    public partial class CFDBLookupService : ICFDBLookupService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CFDBLookupService"/> class.
        /// </summary>
        /// <param name="serviceUrl">The service URL.</param>
        public CFDBLookupService( string serviceUrl )
            : base()
        {
