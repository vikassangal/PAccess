...
namespace PatientAccess.VIWeb
{
    ...
    /// <summary>
    /// Summary description for VIWebPreviousDocumentsService
    /// </summary>
    public partial class PreviousVisitServiceService : IPreviousVisitServiceService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviousVisitServiceService"/> class.
        /// </summary>
        /// <param name="serviceUrl">The service URL.</param>
        public PreviousVisitServiceService( string serviceUrl )
        {
