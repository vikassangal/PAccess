...
namespace PatientAccess.AddressValidationProxy
{
    ...
    /// <summary>
    /// Summary description for AddressValidationService
    /// </summary>
    public partial class AddressValidationService : IAddressValidationService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressValidationService"/> class.
        /// </summary>
        /// <param name="serviceUrl">The service URL.</param>
        public AddressValidationService( string serviceUrl ) : base()
        {
