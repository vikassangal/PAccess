...
/*************I********************************************************/        
/*            I                                                       */        
/* iSeries400 I  DELETEWORKLISTITEMSFORMRNACCOUNTS - SQL PROC FOR PX  */        
/*            I                                                       */        
/*    ************************************************************    */        
...
CREATE PROCEDURE DELETEWORKLISTITEMSFORMRNACCOUNTS (                            
        ...
        LEAVE LOOP1 ;                                                           
        ELSE                                                                    
        CALL DELETEWORKLISTITEMSFORACCOUNT ( P_FACILITYID , ACCNUM ) ;          
        END IF ;                                                                
        END LOOP ;                                                              
        END P1  ;                                                               
