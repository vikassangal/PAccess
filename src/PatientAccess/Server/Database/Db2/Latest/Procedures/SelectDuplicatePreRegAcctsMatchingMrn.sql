/**********************************************************************/
/* AS400 Short Name: SDPRACTMRN                                       */
/* iSeries400        SELECTDUPLICATEPREREGACCTSMATCHINGMRN            */
/*                                                                    */
/*    ************************************************************    */
...
/**************I**********I***********I********************************/
/* 10/02/2007  I  Smitha        I New Stored Procedure                */
/***********I**********I***********I***********************************/
/* 10/23/2007  I  Smitha        I Added new parameter accountnumber   */
...
CREATE PROCEDURE SELECTDUPLICATEPREREGACCTSMATCHINGMRN (
	...
	DATE ( TRIM ( CHAR ( LPP . LPADT1 ) ) || '/' ||
		TRIM ( CHAR ( LPP . LPADT2 ) ) || '/' ||
		TRIM ( LPP . LPADT4 ) ||
		RIGHT ( '0' || TRIM ( CHAR ( LPP . LPADT3 ) ) , 2 ) ) AS ADMISSIONDATE
	FROM
	HPADLPP LPP
	WHERE
	LPP . LPHSP# = P_FACILITYID
	AND LPP . LPMRC# = P_MRN
	AND LPP . LPACCT <> P_ACCOUNTNUMBER 
	AND LPP . LPPTYP = '0'
	AND LPP.LPPSTI <> 'G'
