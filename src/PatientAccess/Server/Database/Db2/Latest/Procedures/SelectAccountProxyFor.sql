...
/* 10/19/2011 I  Nereid Tavares    I Dft18075 - Read ADMITCATEGORY    */        
/*            I                    I   from AccountProxies            */       
/*************I********************I***********************************/        
																				
SET PATH *LIBL ;                                                                
																				
CREATE PROCEDURE &LIBRARY/SELECTACCOUNTPROXYFOR (                                        
		IN P_HSP INTEGER ,                                                      
		IN P_MRC INTEGER ,                                                      
		IN P_ACCOUNTNUMBER INTEGER )                                            
		DYNAMIC RESULT SETS 1                                                   
		LANGUAGE SQL                                                            
		SPECIFIC &LIBRARY/SELACCPXY                                                      
		NOT DETERMINISTIC                                                       
		MODIFIES SQL DATA                                                       
		...
		V . ADMITCATEGORY AS ADMITCATEGORY , 
		V . OPERATINGDRID , 
		V . ATTENDINGDRID , 
		V . ADMITTINGDRID , 
		V . REFERINGDRID , 
