...
/* 02/08/2011 I  Deepa Raju 	   I  Restrict Secondary Financial  */
/*            I        		   I    Classes  */
/*************I********************I***********************************/        
				...
				DECLARE CURSOR1 CURSOR FOR 
					...
					SELECT PLANFINXREF.FCALLOWFC AS FINANCIALCLASSCODE
						...
						WHERE TRIM( PLANFINXREF.FCPLI2 ) = @P_SUFFIX
 							AND PLANFINXREF.FCALLOWFC not in 
							(select RFFNC2 from NHRF01P WHERE RFHSPC = 999 and RFAADT = 'N' and RFLSYS = 'ADT')
