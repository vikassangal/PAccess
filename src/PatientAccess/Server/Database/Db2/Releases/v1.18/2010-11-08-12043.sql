...
/* 03/29/2010 I Modified OtherPhysician Names to PCP                  */   
/* 11/08/2010 I Deepa Raju         I Bug 12043 fix - Modified SP to   */     
/*            I                    I  always return blank for LAMNFR  */     
/*            I                    I  as Non-Staff Physician Number   */     
/*************I********************I***********************************/        
...
CREATE PROCEDURE SELECTNONSTAFFPHYSICIANINFO (                                  
        ...
        P1 : BEGIN                                                              
                ...
                SELECT                                                          
                        ...
                        '' AS ADMITTINGNSPNUM ,        -- Return BLANK for LAMNFR                      
                        ...
                        LATNLN AS PCPNSPLASTNAME ,                            
                        LATNFN AS PCPNSPFIRSTNAME ,                           
                        LATNMN AS PCPNSPMIDINITIAL ,                          
                        LATNU# AS PCPNSPUPIN ,                                
                        LATNPR AS PCPNSPNATLPROVID ,                          
                        LATTXC AS PCPNSPTAXONOMYCD ,                          
                        LATNP# AS PCPNSPPHONENUM ,                             
                        LATSL# AS PCPNSPSTATELICNO ,                          
                        LATECR AS TENETCARE ,                                   
