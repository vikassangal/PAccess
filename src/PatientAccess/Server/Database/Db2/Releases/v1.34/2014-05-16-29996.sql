...
/*            I                    I   HPADLPP table                  */              
/*05/16/2014  I  Srilakshmi         I  SR9336 - Read LPFILL from     */
/*									I   HPADLPP table
/**********************************************************************/                                    
...
CREATE VIEW &LIBRARY/ACCOUNTPROXIES ( 
	...
	LFKEY ,
	PATIENTPORTALOPTIN FOR COLUMN LPFILL )
...
( FACILITYID IS 'HOSP#' , 
	...
	LFKEY IS 'RECORD KEY',
	PATIENTPORTALOPTIN IS 'PATIENTPORTALOPTIN'  ) ; 
...
( FACILITYID TEXT IS 'HOSPITAL NUMBER' , 
	...
	PATIENTPORTALOPTIN TEXT IS 'PATIENTPORTALOPTIN' ) ;
