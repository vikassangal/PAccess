...
--  Generated on:              	08/09/18 01:51:03 
--  Relational Database:       	DVLA 
--  Standards Option:          	DB2 for i 
CREATE VIEW PACCESS.INSURANCES ( 
	HSPNUMBER , 
	...
	INSUREDADDRESS1EXTENDED FOR COLUMN INSUR00022 , 
	INSUREDADDRESS2EXTENDED FOR COLUMN INSUR00023 , 
	...
	SELECT  
	 ...
	 I.HBJADRE1 AS INSUREDADDRESS1EXTENDED,  
	  
	 I.HBJADRE2 AS INSUREDADDRESS2EXTENDED,  
		 ...
		 LEFT OUTER JOIN HPDATA1.HPADLAP7 P  
		  
		 ON ( I.HBMRC# = P.LAMRC# AND I.HBHSP# = P.LAHSP# )  
		  
		 LEFT OUTER JOIN HPDATA1.HPADLAP8 S  
		  
		 ON ( I.HBMRC# = S.LAMRC# AND I.HBHSP# = S.LAHSP# ) ; 
  
LABEL ON COLUMN PACCESS.INSURANCES 
( HSPNUMBER IS 'HOSP#' , 
	...
	INSUREDADDRESS1EXTENDED IS 'SUBSCRIBER ADDRESS1 EXTENDED' , 
	INSUREDADDRESS2EXTENDED IS 'SUBSCRIBER ADDRESS2 EXTENDED' , 
...
( HSPNUMBER TEXT IS 'HOSPITAL NUMBER' , 
	...
	INSUREDADDRESS1EXTENDED TEXT IS 'SUBSCRIBER ADDRESS1 EXTENDED' , 
	INSUREDADDRESS2EXTENDED TEXT IS 'SUBSCRIBER ADDRESS2 EXTENDED' , 
...
ON PACCESS.INSURANCES TO RMTGRPPRF WITH GRANT OPTION ; 
  
GRANT ALTER , REFERENCES , SELECT   
ON PACCESS.INSURANCES TO TURNOVER WITH GRANT OPTION ;
