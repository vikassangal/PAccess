...
/*************I********************I***********************************/        
/*																	  */     
/* 05/06/2010 I Modified to only return a single result based on the  */
/*            I most recent value of Admit date                       */   
/*************I********************I***********************************/        
/* 06/12/2015 I        Smitha      I Modifiedsearch filter to include */
/*            I                    I on Phone number as per           */ 
/*            I                    I requirements for   SR 10336      */  
/*************I********************I***********************************/   

--  Generate SQL 
--  Version:                   	V7R1M0 100423 
--  Generated on:              	06/12/15 08:36:25 
...
IF @V_MEDICALRECORDNUMBER IS NULL AND 
@P_SSN IS NOT NULL THEN 
...
------------------PHYSICAL PHONE------------------------------------ 
ELSEIF @V_MEDICALRECORDNUMBER IS NULL AND 
@P_SSN IS NULL AND @P_PHONENUMBER IS NOT NULL THEN 
  
SET @V_DEMOFILTER = 
' ( DEMOGRAPHICS.MDHSP# = ' || 
@P_FACILITYID || 
' AND DEMOGRAPHICS.MDMRC# IN ' || 
'( SELECT MDMRC# FROM HPADMDP WHERE (  DEMOGRAPHICS.MDPPH#   = ''' || 
...
GRANT ALTER , EXECUTE   
ON SPECIFIC PROCEDURE PADEV.FINDPTSFOR 
TO RMTGRPPRF ;
