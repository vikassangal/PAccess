  ...
  <xsl:template match="/">
    <configuration>
      ...
      <log4net>
        ...
        <!--Don't rename this logger without renaming the same logger on the server side-->
      ...
      <appSettings>
        ...
        <add key="MODEOFARRIVALREQUIRED_START_DATE" value="02/19/2010" />
        ...
        <add key="RIGHTTORESTRICT_START_DATE" value="{/Settings/ClientSettings/WinformClient/RIGHTTORESTRICT_START_DATE_SET[contains(@Environment,$Environment) and (@Branch=$Branch or @Branch='Any')]/text()}" />
        <add key="CPTCODES_START_DATE" value="{/Settings/ClientSettings/WinformClient/CPTCODES_START_DATE_SET[contains(@Environment,$Environment) and (@Branch=$Branch or @Branch='Any')]/text()}" />
        <add key="EMAIL_ADDRESS_REQUIRED_START_DATE" value="{/Settings/ClientSettings/WinformClient/EMAIL_ADDRESS_REQUIRED_START_DATE_SET[contains(@Environment,$Environment) and (@Branch=$Branch or @Branch='Any')]/text()}" />
