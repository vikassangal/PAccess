...
{   
    /// <summary>
    /// DisabilityEntitlementPage2 - the second Entitlement by Disability page; captures wether or not the patient has Group
    /// Health Plan (GHP) coverage through their or their spouse's employer
    /// </summary>
    [Serializable]
    public class DisabilityEntitlementPage2 : WizardPage
    {
        #region Events
        ...
        /// <summary>
        /// DisabilityEntitlementPage2_EnabledChanged - invoke UpdateView if the page is enabled
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DisabilityEntitlementPage2_EnabledChanged(object sender, EventArgs e)
        {
            if( this.Enabled )
            {
                this.UpdateView();
        ...
        /// <summary>
        /// DisabilityEntitlementPage2_Load - load up the page
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DisabilityEntitlementPage2_Load(object sender, EventArgs e)
        {
            this.ShowLink                           = false;

            this.MyWizardMessages.Message1          = "Entitlement by Disability";            
        ...
        {    
            bool rc = this.CanNavigate;

            if( rc )
            {
                DisabilityEntitlementPage3 page3  = this.MyWizardContainer.GetWizardPage( "DisabilityEntitlementPage3" )
        ...
        private bool CanPageNavigate()
        {
            ...
            if( blnCanNav )
            {                    
                this.MyWizardButtons.UpdateNavigation( "&Next >", "DisabilityEntitlementPage3" );  
        ...
        public override void UpdateView()
        {
            ...
            if( !blnLoaded )
            {
                ...
                {   
                    ...
                    if( disabilityEntitlement.GroupHealthPlanCoverage.Code == YesNoFlag.CODE_YES )                        
                    {
                    ...
                    else if(disabilityEntitlement.GroupHealthPlanCoverage.Code == YesNoFlag.CODE_NO )
                    {
                        this.rbQ3No.Checked                         = true;
                    }

                    if( disabilityEntitlement.GHPEmploysMoreThanXFlag.Code == YesNoFlag.CODE_YES )
                    {
                        this.checkBoxYesNoGroup4.rbYes.Checked      = true;
                    }
                    else if ( disabilityEntitlement.GHPEmploysMoreThanXFlag.Code == YesNoFlag.CODE_NO )
                    {
                        this.checkBoxYesNoGroup4.rbNo.Checked      = true;
                    }

                    if( disabilityEntitlement.SpouseGHPEmploysMoreThanXFlag.Code == YesNoFlag.CODE_YES )
                    {
                        this.checkBoxYesNoGroup5.rbYes.Checked      = true;
                    }
                    else if ( disabilityEntitlement.SpouseGHPEmploysMoreThanXFlag.Code == YesNoFlag.CODE_NO )
                    {
        ...
        public override void UpdateModel()
        {
            ...
            else
            {
                    ...
                    != typeof(DisabilityEntitlement) )
                {
                    ...
                    entitlement = this.Model_Account.MedicareSecondaryPayor.MedicareEntitlement as DisabilityEntitlement;
            }
            ...
            {
                entitlement.GHPEmploysMoreThanXFlag.Code    = YesNoFlag.CODE_YES;
            }
            else if( this.checkBoxYesNoGroup4.rbNo.Checked )
            {
                entitlement.GHPEmploysMoreThanXFlag.Code    = YesNoFlag.CODE_NO;
            }
            else
            {
                entitlement.GHPEmploysMoreThanXFlag.Code    = YesNoFlag.CODE_BLANK;
            }

            if( this.checkBoxYesNoGroup5.rbYes.Checked )
            {
                entitlement.SpouseGHPEmploysMoreThanXFlag.Code    = YesNoFlag.CODE_YES;
            }
            else if( this.checkBoxYesNoGroup5.rbNo.Checked )
            {
                entitlement.SpouseGHPEmploysMoreThanXFlag.Code    = YesNoFlag.CODE_NO;
            }
            else
            {
                entitlement.SpouseGHPEmploysMoreThanXFlag.Code    = YesNoFlag.CODE_BLANK;
            }
        ...
        {            
            ...
            this.MyWizardButtons.AddNavigation( "< &Back", GetDisabilityEntitlementPageName() );
        ...
        private void displayInsurance()
        {
            ...
            WizardPage aPage = this.MyWizardContainer.GetWizardPage( "DisabilityEntitlementPage3" );

            if( aPage != null )
            {
                if( ((DisabilityEntitlementPage3)aPage).DisplayInsurance )
                {
                    display = true;
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.lblQuestion4b.Text = "employer, that sponsors or contributes to the GHP, employ 100 or more employees?";
            // 
            // lblQuestion4
            // 
            ...
            this.lblQuestion5c.Text = "employ 100 or more employees?";
            // 
            // pnlQ5Divider
            // 
            ...
            // 
            // DisabilityEntitlementPage2
            // 
            this.Name = "DisabilityEntitlementPage2";
            this.EnabledChanged += new System.EventHandler(this.DisabilityEntitlementPage2_EnabledChanged);
            this.Load += new System.EventHandler(this.DisabilityEntitlementPage2_Load);
        ...
        public DisabilityEntitlementPage2()
        {
        ...
        public DisabilityEntitlementPage2( WizardContainer wizardContainer )
        ...
        public DisabilityEntitlementPage2( string pageName, WizardContainer wizardContainer )
        ...
        public DisabilityEntitlementPage2( string pageName, WizardContainer wizardContainer, Account anAccount )
