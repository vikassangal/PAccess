...
{
    /// <summary>
    /// AgeEntitlementPage1 - the first Entitlement by Age page; captures employment info for the patient
    /// and spouse, if applicable. 
    /// </summary>

    [Serializable]
    public class AgeEntitlementPage1 : WizardPage, IAgeEntitlementPage1View
    {
        #region Events
        ...
        public bool CheckForSummary()
        {
            ...
            if ( rc )
            {
                    ...
                    && !rbQ2Yes.Checked )
                {
                    ...
                    if ( sPage != null )
                    {
                        sPage.MyWizardButtons.UpdateNavigation( "< &Back", "AgeEntitlementPage1" );
                    }
                }
                else
                {
        ...
        public override void UpdateView()
        {
            ...
            if ( !blnLoaded )
            {
                ...
                Presenter = new AgeEntitlementPage1Presenter( this, Model_Account );
            ...
            else
            {
                if ( someoneEmployed == "N" )
                {
                    if ( runRules() )
                    {
                        ...
                        if ( aPage != null )
                        {
                            aPage.MyWizardButtons.UpdateNavigation( "< &Back", "AgeEntitlementPage1" );
                        }
                    }
                }
        ...
        private AgeEntitlementPage1Presenter Presenter { get; set; }
        ...
        public AgeEntitlementPage1( WizardContainer wizardContainer )
        ...
        //TODO-AC-SR352-Delete if not needed
        public AgeEntitlementPage1( string pageName, WizardContainer wizardContainer )
        ...
        public AgeEntitlementPage1( string pageName, WizardContainer wizardContainer, Account anAccount )
