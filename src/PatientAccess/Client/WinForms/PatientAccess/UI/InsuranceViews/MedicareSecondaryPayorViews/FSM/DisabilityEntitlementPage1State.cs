...
{
    /// <summary>
    /// Summary description for DisabilityEntitlementPage1State.
    /// </summary>
    public class DisabilityEntitlementPage1State : FSMState
    {
        #region Construction
        public DisabilityEntitlementPage1State( FSMState state, MSPDialog form,
            Account account, MedicareSecondaryPayor msp, bool tag ) : base( state )
        {
            view = new DisabilityEntitlementPage1View( form );
        ...
        #region Methods
        public static DisabilityEntitlementPage1State GetInstance( FSMState state, MSPDialog form,
            Account account, MedicareSecondaryPayor msp, bool dispose )
        {
            if( dispose || stateExemplar == null )
            {
                stateExemplar = null;
                stateExemplar = new DisabilityEntitlementPage1State( state, form, account, msp, dispose );
            }
            ...
            Account account, MedicareSecondaryPayor msp )
        {
            if( View.FormChanged )
            {
                ControlView cv = DisabilityEntitlementPage2State.GetInstance( this, form, account, msp, false ).View;
                cv.Dispose();
            }
            DisabilityEntitlementPage2State nextState = DisabilityEntitlementPage2State.GetInstance( this, form, account, msp, View.FormChanged );
        ...
        public DisabilityEntitlementPage1View View
        {
            get
            {
                return view;
        ...
        public static DisabilityEntitlementPage1View  view;
        public static DisabilityEntitlementPage1State stateExemplar;
