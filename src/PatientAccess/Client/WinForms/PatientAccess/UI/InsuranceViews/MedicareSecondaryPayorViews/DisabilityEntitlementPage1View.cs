...
{
    /// <summary>
    /// Summary description for DisabilityEntitlementPage1View.
    /// </summary>
    public class DisabilityEntitlementPage1View : ControlView
    {
        [DllImport( "User32.dll", CharSet = CharSet.Auto, SetLastError = true )]
        public static extern IntPtr SendMessage( IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam );

        #region Event Handlers
        private void DisabilityEntitlementPage1View_Load( object sender, EventArgs e )
        {
            if ( Model_MedicareSecondaryPayor == null ) return;

            if ( ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment == null )
            {
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment = new Employment();
            }
            if ( ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment == null )
            {
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment = new Employment();
            }
        }
        ...
        private void mskRetirementDate_Leave( object sender, EventArgs e )
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment.RetiredDate = retirementDate;
                        UIColors.SetNormalBgColor( mtb );
                        Refresh();
        ...
        private void btnMoreInfo_Click( object sender, EventArgs e )
        {
            ...
            int Y = Location.Y + Size.Height / 4;
            DisabilityInfoDialog d = new DisabilityInfoDialog();
            try
            {
        ...
        private void mskSpouseRetirementDate_Leave( object sender, EventArgs e )
        {
            ...
            else
            {
                ...
                {   // Check the date entered is not in the future
                    ...
                    {
                        ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.RetiredDate = spouseRetirementDate;
                        UIColors.SetNormalBgColor( mtb );
                        Refresh();
        ...
        {
            MaskedEditTextBox mtb = ( MaskedEditTextBox )sender;
            ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Employer.Name = mtb.Text.Trim();
        ...
        {
            MaskedEditTextBox mtb = ( MaskedEditTextBox )sender;
            ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Employer.PartyContactPoint.Address.Address1 = mtb.Text.Trim();
        ...
        {
            MaskedEditTextBox mtb = ( MaskedEditTextBox )sender;
            ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Employer.PartyContactPoint.Address.City = mtb.Text.Trim();
        ...
        private void cbStates_SelectedIndexChanged( object sender, EventArgs e )
        {
            ...
            if ( cb.SelectedIndex > 0 )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Employer.PartyContactPoint.Address.State = ( State )state.Clone();
        ...
        private void mskZipCode_Leave( object sender, EventArgs e )
        {
            ...
            {
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Employer.PartyContactPoint.Address.ZipCode.ZipCodePrimary = mtb.Text;
                UIColors.SetNormalBgColor( mtb );
                Refresh();
        ...
        private void mskZipPlusFour_Leave( object sender, EventArgs e )
        {
            ...
            {
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Employer.PartyContactPoint.Address.ZipCode.ZipCodeExtended = mtb.Text;
                UIColors.SetNormalBgColor( mtb );
                Refresh();
        ...
        private void rbQuestion1Yes_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( rb.Checked )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment.Status = EmploymentStatus.NewFullTimeEmployed();

                enableEmploymentButton = rbQuestion2Yes.Checked;
                FormCanTransition();
        ...
        private void rbQuestion1Retired_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( rb.Checked )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment.Status = EmploymentStatus.NewRetired();

                if ( Model_Account.RetirementDate != DateTime.MinValue )
                {   // Redisplay the retirement date if RadioButton is changed back to 'retired'
        ...
        private void rbQuestion1Never_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( rb.Checked )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment.Status = EmploymentStatus.NewNotEmployed();

                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment.RetiredDate = DateTime.MinValue;
        ...
        private void rbQuestion2Yes_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( rb.Checked )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Status = EmploymentStatus.NewFullTimeEmployed();

                enableEmploymentButton = rbQuestion1Yes.Checked;
                FormCanTransition();
        ...
        private void rbQuestion2Retired_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( rb.Checked )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Status = EmploymentStatus.NewRetired();
        ...
        private void rbQuestion2Never_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( rb.Checked )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.Status = EmploymentStatus.NewNotEmployed();
        ...
        public override void UpdateView()
        {
            ...
            else if ( formActivating )
            {
                ...
                {   // If the user didn't change the entitlement type in the previous screen, 
                    ...
                    if ( ( Model_Account.MedicareSecondaryPayor.MedicareEntitlement as DisabilityEntitlement ).PatientEmployment != null )
                    {
                        ...
                        if ( patientEmpStatus != null )
                        {
                            ...
                            else if ( patientEmpStatus.Code.Equals( EmploymentStatus.RETIRED_CODE ) )
                            {
                                if ( Model_Account.IsRetired )
                                {
                                    ...
                                    {   // If retirement date is on account but not on MedicareSecondaryPayor, it should be there. 
                                        ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).PatientEmployment.RetiredDate = date;
                                        mskRetirementDate.Text = String.Format( "{0:D2}{1:D2}{2:D4}", date.Month, date.Day, date.Year );
                                        UIColors.SetNormalBgColor( mskRetirementDate );
                                    }
                                }
                           ...
                           as DisabilityEntitlement ).SpouseEmployment != null )
                    {
                        ...
                        else if ( spouseEmpStatus.Code.Equals( EmploymentStatus.RETIRED_CODE ) )
                        {
                            ...
                            if ( date != DateTime.MinValue )
                            {
                                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment.RetiredDate = date;
                    ...
                    else
                    {
                        ( Model_Account.MedicareSecondaryPayor.MedicareEntitlement as
                          DisabilityEntitlement ).SpouseEmployment = null;
                    }
                }
            }
            FormCanTransition();
        ...
        private void ClearPage2Data()
        {
                ...
                ( rbQuestion2Retired.Checked || rbQuestion2Never.Checked ) )
            {
                ...
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).GHPCoverageOtherThanSpouse.SetBlank();
                ( ( DisabilityEntitlement )Model_MedicareSecondaryPayor.MedicareEntitlement ).GHPLimitExceeded.SetBlank();
                DisabilityEntitlementPage2View.formActivating = true;
        ...
        /// <summary>
        /// Set Enabled property of groupBox and display employment information.
        /// </summary>
        ...
        /// <summary>
        /// Enable or disable & clear the controls 
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.btnMoreInfo = new LoggingButton();
            ...
            this.txtTitle.Text = "Entitlement by Disability";
            // 
            // panel2
            // 
            ...
            // rbQuestion2Never
            // 
            this.rbQuestion2Never.Location = new System.Drawing.Point( 492, 0 );
            this.rbQuestion2Never.Name = "rbQuestion2Never";
            this.rbQuestion2Never.Size = new System.Drawing.Size( 178, 24 );
            this.rbQuestion2Never.TabIndex = 4;
            this.rbQuestion2Never.TabStop = true;
            this.rbQuestion2Never.Text = "No - (Spouse) Never employed";
            this.rbQuestion2Never.CheckedChanged += new System.EventHandler( this.rbQuestion2Never_CheckedChanged );
            // 
            // rbQuestion2Retired
            // 
            this.rbQuestion2Retired.Location = new System.Drawing.Point( 362, 0 );
            this.rbQuestion2Retired.Name = "rbQuestion2Retired";
            this.rbQuestion2Retired.Size = new System.Drawing.Size( 132, 24 );
            this.rbQuestion2Retired.TabIndex = 3;
            this.rbQuestion2Retired.Text = "No - (Spouse) Retired";
            this.rbQuestion2Retired.CheckedChanged += new System.EventHandler( this.rbQuestion2Retired_CheckedChanged );
            // 
            // btnMoreInfo
            // 
            this.btnMoreInfo.Location = new System.Drawing.Point( 235, 0 );
            ...
            this.lblQuestion2.Size = new System.Drawing.Size( 249, 23 );
            this.lblQuestion2.TabIndex = 0;
            this.lblQuestion2.Text = "2. If married, is your spouse currently employed?";
            // 
            // rbQuestion2Yes
            // 
            this.rbQuestion2Yes.Location = new System.Drawing.Point( 316, 0 );
            this.rbQuestion2Yes.Name = "rbQuestion2Yes";
            this.rbQuestion2Yes.Size = new System.Drawing.Size( 48, 24 );
            this.rbQuestion2Yes.TabIndex = 2;
            ...
            // rbQuestion1Never
            // 
            this.rbQuestion1Never.Location = new System.Drawing.Point( 496, 0 );
            this.rbQuestion1Never.Name = "rbQuestion1Never";
            this.rbQuestion1Never.Size = new System.Drawing.Size( 132, 24 );
            ...
            // rbQuestion1Retired
            // 
            this.rbQuestion1Retired.Location = new System.Drawing.Point( 396, 0 );
            this.rbQuestion1Retired.Name = "rbQuestion1Retired";
            this.rbQuestion1Retired.Size = new System.Drawing.Size( 92, 24 );
            ...
            // rbQuestion1Yes
            // 
            this.rbQuestion1Yes.Location = new System.Drawing.Point( 338, 0 );
            ...
            this.lblQuestion1.Size = new System.Drawing.Size( 192, 23 );
            ...
            this.mskRetirementDate.Location = new System.Drawing.Point( 124, 91 );
            ...
            this.lblRetirmentDate.Location = new System.Drawing.Point( 28, 94 );
            ...
            this.lblStaticRetirementDate.TabIndex = 6;
            ...
            // 
            // DisabilityEntitlementPage1View
            // 
            ...
            this.Name = "DisabilityEntitlementPage1View";
            this.Size = new System.Drawing.Size( 680, 520 );
            this.Load += new System.EventHandler( this.DisabilityEntitlementPage1View_Load );
        ...
        #region Construction
        public DisabilityEntitlementPage1View( MSPDialog form )
        {
        ...
        public static bool enableEmploymentButton;
