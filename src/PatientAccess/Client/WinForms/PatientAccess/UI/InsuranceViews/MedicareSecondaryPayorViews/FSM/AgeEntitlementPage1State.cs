...
{
    /// <summary>
    /// Summary description for AgeEntitlementPage1State.
    /// </summary>
    public class AgeEntitlementPage1State : FSMState
    {
        #region Construction
        public AgeEntitlementPage1State( FSMState state, MSPDialog form, Account account,
            MedicareSecondaryPayor msp, bool tag ) : base( state )
        {
            view = new AgeEntitlementPage1View( form );
        ...
        #region Methods
        public static AgeEntitlementPage1State GetInstance( FSMState state, MSPDialog form,
            Account account, MedicareSecondaryPayor msp, bool dispose )
        {
            if( dispose || stateExemplar == null )
            {
                stateExemplar = null;
                stateExemplar = new AgeEntitlementPage1State( state, form, account, msp, dispose );
            }
            ...
            Account account, MedicareSecondaryPayor msp )
        {
            if( View.FormChanged )
            {
                ControlView cv = AgeEntitlementPage2State.GetInstance( this, form, account, msp, false ).View;
                cv.Dispose();
            }
            AgeEntitlementPage2State nextState = AgeEntitlementPage2State.GetInstance( this, form, account, msp, View.FormChanged );
        ...
        public AgeEntitlementPage1View View
        {
            get
            {
                return view;
        ...
        public static AgeEntitlementPage1View  view;
        public static AgeEntitlementPage1State stateExemplar;
