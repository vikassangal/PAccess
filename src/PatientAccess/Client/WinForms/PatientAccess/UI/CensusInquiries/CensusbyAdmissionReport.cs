...
{
    [UsedImplicitly]
    public class CensusbyAdmissionReport : CensusbyADTReport
    {
        #region Events
        #endregion
        ...
        public override void CustomizeGridLayout()
        {
            ...
            patientBand.Header.Caption = ADT_ADMISSION_CAPTION;

            UltraGridBand summaryHeaderBand  = PrintGrid.DisplayLayout.Bands[SUMMARY_HEADER_BAND];
            summaryHeaderBand.Header.Caption = ADT_ADMISSION_CAPTION;
            ...
            patientBand.Columns[COL_PHYSICIANS_CHIEF_COMPLAINT].Hidden = false;
        }
        ...
        public CensusbyAdmissionReport()
        {
        }
        ...
        private const string ADT_ADMISSION_CAPTION = " Admissions";
