...
{
    public partial class QuickAccountCreationView : ControlView, IQuickAccountCreationView
    {
        #region Events
        ...
        private void QuickAccountCreationViewOnEnter( object sender, EventArgs e )
        {
            leavingView = false;
            RegisterEvents();
            RuleEngine.EvaluateRule( typeof( OnQuickAccountCreationForm ), ModelAccount );
        }

        private void QuickAccountCreationViewOnLeave( object sender, EventArgs e )
        {

            blnLeaveRun = true;

            leavingView = true;
            QuickAccountCreationPresenter.UpdateAdmitDate();
        ...
        private void LastNameOnValidating( object sender, CancelEventArgs e )
        {
            ...
            {
                QuickAccountCreationPresenter.UpdateLastName( mtb.Text.Trim() );
            }
        ...
        private void FirstNameOnValidating( object sender, CancelEventArgs e )
        {
            ...
            if ( ModelAccount != null && ModelAccount.Patient != null )
            {
                QuickAccountCreationPresenter.UpdateFirstName( mtb.Text.Trim() );
            }
            if ( RefreshTopPanel != null )
            {
                RefreshTopPanel( this, new LooseArgs( ModelAccount.Patient ) );
        ...
        {
            var mtb = (MaskedEditTextBox)sender;
            QuickAccountCreationPresenter.UpdateMiddleInitial( mtb.Text.Trim() );
        } 
        ...
        private void ProcedureOnValidating( object sender, CancelEventArgs e )
        {
            ...
            QuickDiagnosisViewPresenter.UpdateProcedureField( mtbProcedure.Text );
        }

        private void ComplaintOnValidating( object sender, CancelEventArgs e )
        {
            UIColors.SetNormalBgColor( mtbComplaint );
            QuickDiagnosisViewPresenter.UpdateChiefComplaintField( mtbComplaint.Text );
        ...
        private void AdmitDateOnValidating( object sender, CancelEventArgs e )
        {
            ...
            if ( !QuickAccountCreationPresenter.VerifyAdmitDate() )
            {
            ...
            if ( !dateTimePicker.Focused
                && !blnLeaveRun )
            {
                QuickAccountCreationPresenter.RunAdmitDateValidationRules();
            }
        ...
        private void AdmitTimeOnValidating( object sender, CancelEventArgs e )
        {
            ...
            if ( !QuickAccountCreationPresenter.UpdateAdmitTime() )
            {
                if ( !dateTimePicker.Focused )
                {
                    mtbAdmitTime.Focus();
        ...
        private void DateOfBirthOnValidating( object sender, CancelEventArgs e )
        {
            ...
            if ( !QuickAccountCreationPresenter.UpdateDateOfBirth() )
            {
        ...
        /// </summary>
        private void DemographicsViewOnDisposed( object sender, EventArgs e )
        {
            UnregisterEvents();
        }
        ...
        private void DateTimePickerOnCloseUp( object sender, EventArgs e )
        {
            ...
            if ( ModelAccount.KindOfVisit.Code != VisitType.PREREG_PATIENT &&
                ModelAccount.Activity.GetType().Equals( typeof( QuickAccountCreationActivity ) ) )
            {
        ...
        private void AdmitDateTodayOrGreaterEventHandler( object sender, EventArgs e )
        {
            if ( ModelAccount.Activity.GetType() == typeof( MaintenanceActivity ) ||
                ModelAccount.Activity.GetType() == typeof( QuickAccountMaintenanceActivity ) )
            {
            ...
            else if ( ModelAccount.Activity.GetType() == typeof( QuickAccountCreationActivity ) )
            {
                UIColors.SetErrorBgColor( mtbAdmitDate );
        ...
        {
            if ( ModelAccount.Activity.GetType() == typeof( QuickAccountMaintenanceActivity ) )
            {
                if ( ModelAccount.KindOfVisit == null )
                {
                    return;
        ...
        private void AdmitDateFiveDaysPastEventHandler( object sender, EventArgs e )
        {
            ...
            if ( ModelAccount.Activity.GetType() == typeof( QuickAccountCreationActivity )
        ...
        private void AppointmentOnSelectedIndexChanged( object sender, EventArgs e )
        {
            ...
            QuickAccountCreationPresenter.UpdateAppointment( (ScheduleCode)cbAppointment.SelectedItem );
        ...
        public void PopulateScheduleCodeComboBox( ArrayList scheduleCodes )
        {
            ...
            foreach ( ScheduleCode s in scheduleCodes )
            {
        ...
        public override void UpdateView()
        {
            ...
            QuickAccountCreationPresenter = new QuickAccountCreationPresenter( this, new MessageBoxAdapter(), ModelAccount, RuleEngine.GetInstance() );
            insuranceView.Presenter = new QuickInsurancePresenter( insuranceView, ModelAccount, RuleEngine.GetInstance() );
            ...
            QuickDiagnosisViewPresenter = new QuickDiagnosisViewPresenter( this );
            if ( loadingModelData )
            {   // Initial entry to the form -- initialize controls and get the data from the model.
                QuickAccountCreationPresenter.PopulateFirstName();
                QuickAccountCreationPresenter.PopulateLastName();
                QuickAccountCreationPresenter.PopulateMiddleInitial();

                PopulateGenderAndBirthGender();

                QuickAccountCreationPresenter.PopulateScheduleCodeComboBox();
                QuickAccountCreationPresenter.SetScheduleCode();

                QuickDiagnosisViewPresenter.HandleProcedureField();
                QuickDiagnosisViewPresenter.HandleChiefComplaintField();
                ...
                UpdateViewDetail();
                Coverage primaryCoverage = ModelAccount.Insurance.CoverageFor(CoverageOrder.PRIMARY_OID);
                ResetFinancialClassesView(primaryCoverage);
                ...
                QuickAccountCreationPresenter.SetAdmitDateOnUIFromTheModel();
                QuickAccountCreationPresenter.SetAdmitTimeOnUIFromTheModel();

                if ( !QuickAccountCreationPresenter.PopulateDateOfBirth() )
                {
                    UIColors.SetErrorBgColor( mtbDateOfBirth );
                }

                QuickAccountCreationPresenter.SetDateOfBirthAndAge();

                ssnView.Model = ModelAccount.Patient;
                ssnView.ModelAccount = ModelAccount;
                ssnView.UpdateView();
                QuickAccountCreationPresenter.AdmitDateUnaltered();
        ...
        private IQuickDiagnosisViewPresenter QuickDiagnosisViewPresenter { get; set; }

        private IQuickAccountCreationPresenter QuickAccountCreationPresenter { get; set; }
        ...
        {
            ModelAccount.FinancialClass = new FinancialClass( 296L, PersistentModel.NEW_VERSION, "MED (MSE) SCREEN EXM", MED_MSE_SCREEN_EXM );
        ...
        private void PopulateFinancialClass()
        {
            ...
            if ( ModelAccount.FinancialClass != null )
            {
                insuranceView.financialClassesView.SetSelectedFinancialClass( ModelAccount.FinancialClass );
            }
        }
        ...
        public QuickAccountCreationView()
        {
            InitializeComponent();
            ConfigureControls();
        }
