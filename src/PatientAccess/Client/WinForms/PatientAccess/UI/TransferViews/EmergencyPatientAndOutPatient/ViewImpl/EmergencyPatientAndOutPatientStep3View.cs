...
{
    public class EmergencyPatientAndOutPatientStep3View : ControlView
    {
        #region Events
        ...
        private void RequiredFieldSummaryTabSelectedEvent(object sender, EventArgs e)
        {
        ...
        private Coverage GetPrimaryCoverage()
        {
            ...
            var coverageCollection = insurance.Coverages;
        ...
        private void TransferERPatToOutPatStep3View_Load(object sender, EventArgs e)
        {
            HidePanel();
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (!RuleEngine.EvaluateAllRules(Model))
            {
                    ...
                    && Rules.RuleEngine.AccountHasRequiredFields(collection))
                {
                    ...
                    requiredFieldsSummaryPresenter = new RequiredFieldsSummaryPresenter(requiredFieldSummaryView,
                                                                                        collection)
                        {
                            Model = Model,
                            Header =
                                RequiredFieldsSummaryPresenter.REQUIRED_FIELDS_HEADER
                        };
        ...
        public void EvaluateNoPrimaryMedicareForAutoAccidentRuleOnFinish(EventHandler eventHandler)
        {
            var noPrimaryMedicareForAutoAccidentRuleChecked = MessageStateManager.
        ...
        private void InitializeComponent()
        {
            ...
            this.panelTransferERPatToOutPat.Controls.Add(this.insuranceView1);
            this.panelTransferERPatToOutPat.Controls.Add(this.lblStep3);
            ...
            // 
            // TransferERPatToOutPatStep3View
            // 
            this.Load += new EventHandler(TransferERPatToOutPatStep3View_Load);
            ...
            this.Name = "EmergencyPatientAndOutPatientStep3View";
        ...
        public EmergencyPatientAndOutPatientStep3View()
            : this(new MessageDisplayStateManager(), Rules.RuleEngine.GetInstance())
        {
        }

        public EmergencyPatientAndOutPatientStep3View(IMessageDisplayStateManager messageStateManager,
