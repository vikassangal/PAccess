...
using PatientAccess.UI.ShortRegistration.BillingViews;
using PatientAccess.UI.ShortRegistration.DemographicsViews;
using PatientAccess.UI.ShortRegistration.DiagnosisViews;
using PatientAccess.UI.ShortRegistration.GuarantorViews;
using PatientAccess.UI.ShortRegistration.RegulatoryViews;
using PatientAccess.UI.WorklistViews;
using log4net;
using OnInsuranceForm = PatientAccess.Rules.OnInsuranceForm;
using OnShortBillingForm = PatientAccess.Rules.OnShortBillingForm;
using OnShortDemographicsForm = PatientAccess.Rules.OnShortDemographicsForm;
using OnShortDiagnosisForm = PatientAccess.Rules.OnShortDiagnosisForm;
using OnShortGuarantorForm = PatientAccess.Rules.OnShortGuarantorForm;
using OnShortRegulatoryForm = PatientAccess.Rules.OnShortRegulatoryForm;

namespace PatientAccess.UI.ShortRegistration
{
    [Serializable]
    [UsedImplicitly]
    public class ShortAccountView : LoggingControlView, IAccountView
    {
        #region Events
        ...
        private void SetTabPageEventHandler( object sender, EventArgs e )
        {
            ...
            switch ( ( ShortRegistrationScreenIndexes )selectedScreenIndex )
            {
                case ShortRegistrationScreenIndexes.INSURED:
                    DisplayInsuredDialogPage( CoverageOrder.NewPrimaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.SECONDARYINSURED:
                    DisplayInsuredDialogPage( CoverageOrder.NewSecondaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.PAYORDETAILS:
                    DisplayPayorDetailsDialogPage( CoverageOrder.NewPrimaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.SECONDARYPAYORDETAILS:
                    DisplayPayorDetailsDialogPage( CoverageOrder.NewSecondaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.PRIMARYINSVERIFICATION:
                    DisplayInsuranceVerificationPage( CoverageOrder.NewPrimaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.SECONDARYINSVERIFICATION:
                    DisplayInsuranceVerificationPage( CoverageOrder.NewSecondaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.PRIMARYAUTHORIZATION:
                    DisplayInsuranceAuthorizationPage( CoverageOrder.NewPrimaryCoverageOrder() );
                    break;

                case ShortRegistrationScreenIndexes.SECONDARYAUTHORIZATION:
        ...
        private void SetNonStaffPhysicianTabPageEventHandler( object sender, EventArgs e )
        {
            ...
            tcViewTabPages.SelectedIndex = ( int )ShortRegistrationScreenIndexes.SHORTDIAGNOSIS;
            PhysicianSearchFormView physicianSearchForm =
                PhysicianSearchFormView.GetPhysicianSearchForm( ( ShortRegistrationScreenIndexes )selectedScreenIndex, Model_Account );
        ...
        private static bool IsNonStaffPhysicianScreenIndex( int selectedScreenIndex )
        {
            return ( ( ( ShortRegistrationScreenIndexes )selectedScreenIndex == ShortRegistrationScreenIndexes.REFERRINGNONSTAFFPHYSICIAN ) ||
                     ( ( ShortRegistrationScreenIndexes )selectedScreenIndex == ShortRegistrationScreenIndexes.ADMITTINGNONSTAFFPHYSICIAN ) ||
                     ( ( ShortRegistrationScreenIndexes )selectedScreenIndex == ShortRegistrationScreenIndexes.ATTENDINGNONSTAFFPHYSICIAN ) ||
                     ( ( ShortRegistrationScreenIndexes )selectedScreenIndex == ShortRegistrationScreenIndexes.OPERATINGNONSTAFFPHYSICIAN ) ||
                     ( ( ShortRegistrationScreenIndexes )selectedScreenIndex == ShortRegistrationScreenIndexes.PRIMARYCARENONSTAFFPHYSICIAN )
                   );
        }
        ...
        {
            const int index = ( int )ShortRegistrationScreenIndexes.INSURANCE;
            ...
            if ( !RuleEngine.EvaluateAllRules( Model_Account ) )
            {
                     ...
                     Rules.RuleEngine.AccountHasRequiredFields( collection ) )
                {
                    ...
                    RequiredFieldsSummaryPresenter = new RequiredFieldsSummaryPresenter( RequiredFieldSummaryView, collection )
                                                     {
                                                         Model = Model_Account,
                                                         Header = UI.CommonControls.RequiredFieldsSummaryPresenter.REQUIRED_FIELDS_HEADER
                                                     };
        ...
        private void EvaluateNoPrimaryMedicareForAutoAccidentRuleOnFinish( EventHandler eventHandler )
        {
        ...
        public void DisplayLocationRequiredFieldSummary()
        {
            ...
            // - Since no bed assignment is necessary during the 3 Short Registration activities.
        }
        ...
        public void ActivateDemographicsTab()
        {
            ...
            {
                Model_Account.Activity = new ShortMaintenanceActivity();
            }

            tcViewTabPages.SelectedIndex = ( int )ShortRegistrationScreenIndexes.SHORTDEMOGRAPHICS;
        ...
        public void ActivateInsuranceTab()
        {
            ...
            tcViewTabPages.SelectedIndex = ( int )ShortRegistrationScreenIndexes.INSURANCE;
        ...
        public void ActivateGuarantorTab()
        {
            ...
            tcViewTabPages.SelectedIndex = ( int )ShortRegistrationScreenIndexes.SHORTGUARANTOR;
        ...
        public void ActivateCounselingTab()
        {
            ...
            tcViewTabPages.SelectedIndex = ( int )ShortRegistrationScreenIndexes.COUNSELING;
        ...
        public void ActivatePaymentTab()
        {
            ...
            tcViewTabPages.SelectedIndex = ( int )ShortRegistrationScreenIndexes.PAYMENT;
        ...
        private void SetActiveTab()
        {
            ...
            switch ( ActivatingTab )
            {
                case "Billing":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SHORTBILLING;
                        break;
                    }
                case "Counseling":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.COUNSELING;
                        break;
                    }
                case "Demographics":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SHORTDEMOGRAPHICS;
                        break;
                    }
                case "Diagnosis":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SHORTDIAGNOSIS;
                        break;
                    }
                case "Guarantor":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SHORTGUARANTOR;
                        break;
                    }
                case "Regulatory":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SHORTREGULATORYANDDOCUMENTS;
                        break;
                    }
                case "Insurance":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.INSURANCE;
                        break;
                    }
                case "Insured":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.INSURED;
                        break;
                    }
                case "SecondaryInsured":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SECONDARYINSURED;
                        break;
                    }
                case "Payor":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.PAYORDETAILS;
                        break;
                    }
                case "SecondaryPayor":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SECONDARYPAYORDETAILS;
                        break;
                    }
                case "Payment":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.PAYMENT;
                        break;
                    }
                case "PrimaryInsuranceVerification":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.PRIMARYINSVERIFICATION;
                        break;
                    }
                case "SecondaryInsuranceVerification":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SECONDARYINSVERIFICATION;
                        break;
                    }
                case "PrimaryAuthorization":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.PRIMARYAUTHORIZATION;
                        break;
                    }
                case "SecondaryAuthorization":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SECONDARYAUTHORIZATION;
                        break;
                    }
                case "ShortDemographics":
                    {
                        index = ( int )ShortRegistrationScreenIndexes.SHORTDEMOGRAPHICS;
                        break;
                    }
        ...
        private void AfterSaveAccount( object sender, RunWorkerCompletedEventArgs e )
        {
            ...
            if ( e.Cancelled )
            {
                ...
                btnNext.Enabled = ( tcViewTabPages.SelectedTab != tpRegulatory );
        ...
        private void DoSaveAccount( object sender, DoWorkEventArgs e )
        {
            ...
            //If this is a Convert To Short Prereg activity, set the currentActivity to MaintenanceActivity so broker can handle it.
            if ( Model_Account.Activity.GetType().Equals( typeof( ShortPreRegistrationActivity ) )
                && Model_Account.Activity.AssociatedActivityType.Equals( typeof( MaintenanceActivity ) ) )
                    ...
                    if ( financialClass.IsSpecialtyMedicare() )
                    {
                        ...
                        if ( primaryCoverage != null && primaryCoverage.InsurancePlan != null )
                        {
                            isValidMappingForPrimary = IsValidHSVPlanForSpecialtyMedicare( hospitalService.Code,
                                                                primaryCoverage.InsurancePlan.PlanID );
                        }
                        if ( !isValidMappingForPrimary )
                        {
                            ...
                            else
                            {
                                bool isValidMappingForSecondary = IsValidHSVPlanForSpecialtyMedicare( hospitalService.Code,
                                                                        secondaryCoverage.InsurancePlan.PlanID );
        ...
        private static bool IsValidHSVPlanForSpecialtyMedicare( string hsvCode, string planId )
        {
            ...
            bool isValidMapping = insuranceBroker.IsValidHSVPlanForSpecialtyMedicare( User.GetCurrent().Facility.Oid, 
                                    hsvCode, planId );
        ...
        {
            IDataValidationBroker iBroker = BrokerFactory.BrokerOfType<IDataValidationBroker>();
        ...
        private bool CheckForAgeOver65Error()
        {
            ...
            if ( !rcErrors )
            {
                if ( Over65Check && tcViewTabPages.SelectedIndex == ( int )ShortRegistrationScreenIndexes.INSURANCE )
                {
                    rcErrors = true;
                }
            }
        ...
        private void processTab()
        {
            try
            {
                ...
                {
                    BreadCrumbLogger.GetInstance.Log( tcViewTabPages.SelectedTab.Text + " tab selected", Model_Account );
                }
        ...
        private void runRulesForTab()
        {
            if ( tcViewTabPages.SelectedTab == tpDemographics )
            {
                RuleEngine.EvaluateRule( typeof( OnShortDemographicsForm ), Model_Account );
            }
            else if ( tcViewTabPages.SelectedTab == tpDiagnosis )
            {
                RuleEngine.EvaluateRule( typeof( OnShortDiagnosisForm ), Model_Account );
            }
            else if ( tcViewTabPages.SelectedTab == tpInsurance )
            {
            ...
            {
                RuleEngine.EvaluateRule( typeof( OnShortGuarantorForm ), Model_Account );
            }
            else if ( tcViewTabPages.SelectedTab == tpBilling )
            {
                RuleEngine.EvaluateRule( typeof( OnShortBillingForm ), Model_Account );
            }
            else if ( tcViewTabPages.SelectedTab == tpCounseling )
            {
                // ???
            ...
            {
                RuleEngine.EvaluateRule( typeof( OnShortRegulatoryForm ), Model_Account );
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager( typeof( ShortAccountView ) );
            this.userContextView = new PatientAccess.UI.UserContextView();
            this.patientContextView = new PatientAccess.UI.PatientContextView();
            this.guarantorView = new PatientAccess.UI.ShortRegistration.GuarantorViews.ShortGuarantorView();
            ...
            this.billingView = new PatientAccess.UI.ShortRegistration.BillingViews.ShortBillingView();
            this.insuranceView = new PatientAccess.UI.InsuranceViews.InsuranceView();
            this.demographicsView = new PatientAccess.UI.ShortRegistration.DemographicsViews.ShortDemographicsView();
            ...
            this.regulatoryView = new PatientAccess.UI.ShortRegistration.RegulatoryViews.ShortRegulatoryView();
            ...
            this.tpDiagnosis.Text = "Diagnosis / Clinical";
            // 
            // tpInsurance
            // 
            ...
            this.tpRegulatory.Text = "Regulatory / Documents";
            // 
            // pnlRegulatoryView
            // 
            ...
            this.regulatoryView.Size = new System.Drawing.Size( 1024, 378 );
        ...
        public static ShortAccountView GetInstance()
        {
            ...
            if ( c_singletonInstance == null )
            {
                lock ( c_syncRoot )
                {
                    if ( c_singletonInstance == null )
                    {
                        c_singletonInstance = new ShortAccountView();
                    }
                }
            }
        ...
        public static ShortAccountView NewInstance()
        {
            if ( c_singletonInstance != null )
            {
        ...
        protected ShortAccountView()
            : this( new MessageDisplayStateManager(), Rules.RuleEngine.GetInstance() )
        {
        }
        public ShortAccountView( IMessageDisplayStateManager messageStateManager, IRuleEngine ruleEngine )
        {
            EnableInsuranceTab = false;
            ...
            diagnosisView = ViewFactory.Instance.CreateView<ShortDiagnosisView>();
        ...
        private ShortBillingView billingView;
        private CopyPartyView copyPartyView;
        private ShortDemographicsView demographicsView;
        private ShortDiagnosisView diagnosisView;
        private ShortGuarantorView guarantorView;
        private InsuranceView insuranceView;
        private PatientContextView patientContextView;
        private UserContextView userContextView;
        private ShortRegulatoryView regulatoryView;
        ...
        private FinancialCouncelingService i_FinancialCouncelingService = null;
        private static ShortAccountView c_singletonInstance;
        ...
        private static readonly ILog c_log = LogManager.GetLogger( typeof( ShortAccountView ) );

        private ICOBReceivedAndIMFMReceivedFeatureManager cobReceivedAndIMFMReceivedFeatureManager;
        public enum ShortRegistrationScreenIndexes
        {
            SHORTDEMOGRAPHICS,
            SHORTDIAGNOSIS,
            INSURANCE,
