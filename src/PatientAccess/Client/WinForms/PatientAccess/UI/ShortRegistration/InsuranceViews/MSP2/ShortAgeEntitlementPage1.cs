...
namespace PatientAccess.UI.ShortRegistration.InsuranceViews.MSP2
{
    /// <summary>
    /// ShortAgeEntitlementPage1 - the first Entitlement by Age page; captures employment info for the patient
    /// and spouse, if applicable. 
    /// </summary>

    [Serializable]
    public class ShortAgeEntitlementPage1 : WizardPage, IAgeEntitlementPage1View
    {
        #region Events
        ...
        {
            BreadCrumbLogger.GetInstance.Log( "Selecting MSP Age Entitlement employer for " + Model_Account.Patient.FormattedName );
            OnSelectEmployer();
        }
        ...
        private void OnSelectEmployer()
        {
            ...
            try
            {
                ...
                {
                    SelectedPatientEmployment = new Employment { Employer = formSelectEmployer.SelectedEmployer };

                    if ( formSelectEmployer.SelectedContactPoint.Address.Address1.Length > 0 )
                    {
                        SelectedPatientEmployment.Employer.PartyContactPoint = formSelectEmployer.SelectedContactPoint;
                    }
        ...
        private void checkDate( MaskedEditTextBox mtb )
        {
            ...
            if ( mtb.UnMaskedText != string.Empty && mtb.Text.Length != 0 )
            {
                try
        ...
        /// <summary>
        /// mtbQ2DateOfRetirement_Leave - check the date foramt
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void rbQ1NoRetired_CheckedChanged( object sender, EventArgs e )
        {
            ...
            DisplayPatientEmployment( false );
        ...
        private void rbQ2Yes_CheckedChanged( object sender, EventArgs e )
        {
            ...
            if ( Model_Account != null
                ...
                && Model_Account.MedicareSecondaryPayor.MedicareEntitlement.GetType() == typeof( AgeEntitlement ) )
            {
                Employment spouseEmployment = ( Model_Account.MedicareSecondaryPayor.MedicareEntitlement ).SpouseEmployment;
                DisplaySpouseEmployment( spouseEmployment );
            }
        ...
        /// <summary>
        /// pnlQ1RadioButtons_GotFocus - default a radio button if none selected and the user tabbed to or clicked on 
        /// the control
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// pnlQ2RadioButtons_GotFocus - default a radio button if none selected and the user tabbed to or clicked on 
        /// the control
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// AgeEntitlementPage1_EnabledChanged - invoke UpdateView if the page is enabled
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>

        private void AgeEntitlementPage1_EnabledChanged( object sender, EventArgs e )
        {
            if ( Enabled )
            {
                UpdateView();
        ...
        /// <summary>
        /// AgeEntitlementPage1_Load - load up the page
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>

        private void AgeEntitlementPage1_Load( object sender, EventArgs e )
        {
            LinkName = "Entitlement by Age";
            MyWizardMessages.Message1 = "Entitlement by Age";
        ...
        public bool CheckForSummary()
        {
            ...
            if ( rc )
            {
                ...
                if ( !rbQ1Yes.Checked
                    && !rbQ2Yes.Checked )
                {
                    // both not employed... skip page 2

                    rc = true;
                    MyWizardButtons.UpdateNavigation( "&Continue to Summary", "SummaryPage" );
                    MyWizardButtons.SetAcceptButton( "&Continue to Summary" );

                    WizardPage sPage = MyWizardContainer.GetWizardPage( "SummaryPage" );

                    if ( sPage != null )
                    {
                        sPage.MyWizardButtons.UpdateNavigation( "< &Back", "ShortAgeEntitlementPage1" );
                    }
                }
                else
                {
                    AgeEntitlementPage2 aPage = MyWizardContainer.GetWizardPage( "AgeEntitlementPage2" )
                        as AgeEntitlementPage2;

                    if ( aPage != null )
                    {
                        if ( aPage.CheckForSummary() )
                        {
                            rc = true;
                            MyWizardButtons.UpdateNavigation( "&Continue to Summary", "SummaryPage" );
                            MyWizardButtons.SetAcceptButton( "&Continue to Summary" );
        ...
        public override void UpdateView()
        {
            ...
            if ( !blnLoaded )
            {
                ...
                Presenter = new ShortAgeEntitlementPage1Presenter( this, Model_Account );
                Presenter.UpdateView();
            }
        ...
        public override void UpdateModel()
        {
            ...
            else
            {
                    ...
                    != typeof( AgeEntitlement ) )
                {
                    ...
                    entitlement = ( AgeEntitlement )Model_Account.MedicareSecondaryPayor.MedicareEntitlement;
            }

            if ( rbQ1Yes.Checked )
            {
                if ( SelectedPatientEmployment != null )
                {
                    entitlement.PatientEmployment = SelectedPatientEmployment;
                    Model_Account.Patient.Employment = SelectedPatientEmployment;
                }
            ...
            // if neither the patient nor spouse are employed, clean up fields from Age page 2...
        ...
        {
            bool canNav = false;
            string someoneEmployed = string.Empty;
            ...
            if ( rbQ1Yes.Checked || rbQ2Yes.Checked )
            {
                someoneEmployed = "Y";
            }
            else if ( ( rbQ1NoNever.Checked || rbQ1NoRetired.Checked ) &&
                      ( rbQ2NoNever.Checked || rbQ2NoRetired.Checked ) )
            {
                someoneEmployed = "N";
            }

            if ( someoneEmployed == "Y" )
            {
                if ( ( rbQ1NoNever.Checked || rbQ1Yes.Checked || 
                     ( rbQ1NoRetired.Checked && mtbQ1DateOfRetirement.UnMaskedText.Trim() != string.Empty ) )
                    &&
                     ( rbQ2NoNever.Checked || rbQ2Yes.Checked || 
                   ...
                   )
                {
                    if ( runRules() )
                    {
                        ...
                        MyWizardButtons.UpdateNavigation( "&Next >", "AgeEntitlementPage2" );
            ...
            else
            {
                if ( someoneEmployed == "N" )
                {
                    if ( runRules() )
                    {
                        ...
                        WizardPage aPage = MyWizardContainer.GetWizardPage( "SummaryPage" );

                        if ( aPage != null )
                        {
                            aPage.MyWizardButtons.UpdateNavigation( "< &Back", "ShortAgeEntitlementPage1" );
                        }
                    }
                }
        ...
        {
            if ( Model_Account.MedicareSecondaryPayor == null ||
                 Model_Account.MedicareSecondaryPayor.MedicareEntitlement == null )
            {
                return String.Empty;
            }
            ...
            AgeEntitlement ageEntitlement = Model_Account.MedicareSecondaryPayor.MedicareEntitlement as AgeEntitlement;

            if ( ageEntitlement == null ||
                 ageEntitlement.PatientEmployment == null ||
                 ageEntitlement.PatientEmployment.Employer.PartyContactPoint.Address == null )
            {
                return String.Empty;
            }
            ...
            Address addr = ageEntitlement.PatientEmployment.Employer.PartyContactPoint.Address;

            if ( ageEntitlement.PatientEmployment.Employer != null )
            {
                msg.Append( ageEntitlement.PatientEmployment.Employer.Name );
            }
        ...
        public void DisplayPatientEmployment( bool display )
        {
            if ( display )
            {
                string employer = buildEmploymentAddress();

                lblQ1EmployerInfo.Text = employer != String.Empty ? employer : EMPTY_EMPLOYER_TEXT;
            }
            else
            {
        ...
        /// <summary>
        /// displaySouseEmployment - display the patient's spouse's employment
        /// </summary>
        /// <param name="spouseEmployment"></param>
        public void DisplaySpouseEmployment( Employment spouseEmployment )
        {
        ...
        private void ClearSpouseEmploymentFields()
        {
        ...
        private bool runRules()
        {
            ...
            UIColors.SetNormalBgColor( cmbQ2State );
            UIColors.SetNormalBgColor( mtbQ2ZipCode );
            UIColors.SetNormalBgColor( lblQ1EmployerInfo );

            Refresh();
            if ( ( pnlQuestion1.Enabled
              &&  rbQ1Yes.Checked )
              && lblQ1EmployerInfo.Text.Trim() == EMPTY_EMPLOYER_TEXT )
            {
                UIColors.SetRequiredBgColor( lblQ1EmployerInfo );
                blnRC = false;
            }
            if ( ( pnlQuestion1.Enabled
                && mtbQ1DateOfRetirement.Enabled )
            ...
            if ( ( pnlQuestion2b.Enabled
                && mtbQ2DateOfRetirement.Enabled )
            ...
            if ( ( pnlQuestion2.Enabled
                && mtbQ2EmployerName.Enabled )
        ...
        private ShortAgeEntitlementPage1Presenter Presenter { get; set; }

        public string SpouseRetirementDateText
        {
            get
            {
                return mtbQ2DateOfRetirement.Text;
            }
            set
            {
                mtbQ2DateOfRetirement.Text = value;
            }
        }
        ...
        public bool SpouseEmployed
        {
            get
            {
                return rbQ2Yes.Checked;
            }
            set
            {
                rbQ2Yes.Checked = value;
            }
        }

        public bool SpouseNeverEmployed
        {
            get
            {
                return rbQ2NoNever.Checked;
            }
            set
            {
                rbQ2NoNever.Checked = value;
            }
        }

        public bool SpouseRetired
        {
            get
            {
                return rbQ2NoRetired.Checked;
            }
            set
            {
                rbQ2NoRetired.Checked = value;
            }
        }

        public bool SpouseOtherEmployed
        {
            get
            {
                return ( rbQ2NoRetired.Checked && 
                         SpouseRetirementDateText == String.Empty );
            }
            set
            {
                rbQ2NoRetired.Checked = value;
        ...
        public string PatientRetirementDateText
        {
            get
            {
                return mtbQ1DateOfRetirement.Text;
            }
            set
            {
                mtbQ1DateOfRetirement.Text = value;
            }
        }

        public bool PatientEmployed
        {
            get
            {
                return rbQ1Yes.Checked;
            }
            set
            {
                rbQ1Yes.Checked = value;
            }
        }

        public bool PatientNeverEmployed
        {
            get
            {
                return rbQ1NoNever.Checked;
            }
            set
            {
                rbQ1NoNever.Checked = value;
            }
        }

        public bool PatientRetired
        {
            get
            {
                return rbQ1NoRetired.Checked;
            }
            set
            {
                rbQ1NoRetired.Checked = value;
            }
        }

        public bool PatientOtherEmployed
        {
            get
            {
                return ( rbQ1NoRetired.Checked &&
                         PatientRetirementDateText == String.Empty );
            }
            set
            {
                rbQ1NoRetired.Checked = value;
        ...
        private Employment SelectedPatientEmployment { get; set; }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager( typeof( ShortAgeEntitlementPage1 ) );
            ...
            this.pnlDivider1.Location = new System.Drawing.Point( 21, 55 );
            ...
            this.pnlQuestion1.Location = new System.Drawing.Point( 7, 71 );
            ...
            this.mtbQ1DateOfRetirement.KeyPressExpression = "^\\d*$";
            ...
            this.mtbQ1DateOfRetirement.ValidationExpression = resources.GetString( "mtbQ1DateOfRetirement.ValidationExpression" );
            this.mtbQ1DateOfRetirement.EnabledChanged += new System.EventHandler( this.runRules );
            this.mtbQ1DateOfRetirement.Leave += new System.EventHandler( this.mtbQ1DateOfRetirement_Leave );
            // 
            // pnlQ1RadioButtons
            // 
            ...
            // btnQ1EditEmployment
            // 
            this.btnQ1EditEmployment.Location = new System.Drawing.Point( 283, 24 );
            this.btnQ1EditEmployment.Message = null;
            this.btnQ1EditEmployment.Name = "btnQ1EditEmployment";
            this.btnQ1EditEmployment.Size = new System.Drawing.Size( 103, 23 );
            this.btnQ1EditEmployment.TabIndex = 2;
            this.btnQ1EditEmployment.Text = "Select Employer";
            ...
            this.lblQ1EmployerInfo.TextChanged += new System.EventHandler( this.runRules );
            // 
            // pnlQuestion2
            // 
            ...
            this.pnlQuestion2.Location = new System.Drawing.Point( 7, 228 );
            ...
            this.mtbQ2DateOfRetirement.KeyPressExpression = "^\\d*$";
            ...
            this.mtbQ2DateOfRetirement.ValidationExpression = resources.GetString( "mtbQ2DateOfRetirement.ValidationExpression" );
            this.mtbQ2DateOfRetirement.EnabledChanged += new System.EventHandler( this.runRules );
            this.mtbQ2DateOfRetirement.Leave += new System.EventHandler( this.mtbQ2DateOfRetirement_Leave );
            // 
            ...
            this.lblQuestion2.Size = new System.Drawing.Size( 201, 23 );
            this.lblQuestion2.TabIndex = 8;
            this.lblQuestion2.Text = "2. Is your spouse currently employed?";
            // 
            // pnlQuestion2c
            // 
            ...
            this.mtbQ2EmployerName.MaxLength = 23;
            ...
            // 
            // ShortAgeEntitlementPage1
            // 
            this.Name = "ShortAgeEntitlementPage1";
            this.Load += new System.EventHandler( this.AgeEntitlementPage1_Load );
            this.EnabledChanged += new System.EventHandler( this.AgeEntitlementPage1_EnabledChanged );
            this.pnlWizardPageBody.ResumeLayout( false );
            this.pnlQuestion1.ResumeLayout( false );
            this.pnlQuestion1b.ResumeLayout( false );
            this.pnlQuestion1b.PerformLayout();
            ...
            this.gbQ2SpouseEmployer.PerformLayout();
        ...
        public ShortAgeEntitlementPage1()
        {
        ...
        public ShortAgeEntitlementPage1( WizardContainer wizardContainer )
        ...
        public ShortAgeEntitlementPage1( string pageName, WizardContainer wizardContainer )
        ...
        public ShortAgeEntitlementPage1( string pageName, WizardContainer wizardContainer, Account anAccount )
        ...
        private string EMPTY_EMPLOYER_TEXT = "Not available";
