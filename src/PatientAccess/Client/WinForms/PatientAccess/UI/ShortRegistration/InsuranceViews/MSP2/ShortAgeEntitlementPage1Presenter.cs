...
{
    internal class ShortAgeEntitlementPage1Presenter
    {
        private const string DATE_FORMAT = "{0:D2}{1:D2}{2:D4}";

        #region Construction

        internal ShortAgeEntitlementPage1Presenter( IAgeEntitlementPage1View view, Account account )
        {
            View = view;
            Account = account;
        }
        ...
        private IAgeEntitlementPage1View View { get; set; }
        ...
        private void PopulateSpouseEmploymentFields()
        {
            if ( Account == null
                || Account.MedicareSecondaryPayor == null
                || ( Account.MedicareSecondaryPayor.MedicareEntitlement as AgeEntitlement ) == null )
        ...
        private void DisplayPatientFullOrPartTimeEmployment()
        {
            ...
            View.DisplayPatientEmployment( true );
        }
