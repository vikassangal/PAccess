...
{
    /// <summary>
    /// ShortDisabilityEntitlementPage1 - the first Entitlement by disability page; captures employment info
    /// for the patient and spouse, if applicable
    /// </summary>

    [Serializable]
    public class ShortDisabilityEntitlementPage1 : WizardPage, IDisabilityEntitlementPage1View
    {
        #region Events
        ...
        {
            BreadCrumbLogger.GetInstance.Log( "Selecting MSP Disability Entitlement employer for " + Model_Account.Patient.FormattedName );
            OnSelectEmployer();
        }
        ...
        private void PopulatePatientEmploymentFields()
        {
            if ( Model_Account == null ||
                 Model_Account.MedicareSecondaryPayor == null ||
                 ( Model_Account.MedicareSecondaryPayor.MedicareEntitlement as DisabilityEntitlement ) == null )
                     ...
                     as DisabilityEntitlement ).PatientEmployment != null )
                {
                    ...
                    if ( patientEmpStatus != null )
                    {
                        ...
                        else if ( patientEmpStatus.Code.Equals( EmploymentStatus.RETIRED_CODE ) )
                        {
                            ...
                            if ( date != DateTime.MinValue )
                            {
                                mtbQ1DateOfRetirement.Text = String.Format( "{0:D2}{1:D2}{2:D4}", date.Month,
                                                                           date.Day, date.Year );
                            }
        ...
        private string buildEmploymentAddress()
        {
            ...
            DisabilityEntitlement disabilityEntitlement = Model_Account.MedicareSecondaryPayor.MedicareEntitlement as DisabilityEntitlement;

            if ( disabilityEntitlement == null ||
                 disabilityEntitlement.PatientEmployment == null ||
                 disabilityEntitlement.PatientEmployment.Employer.PartyContactPoint.Address == null )
            {
                return String.Empty;
            }
            ...
            Address addr = disabilityEntitlement.PatientEmployment.Employer.PartyContactPoint.Address;

            if ( disabilityEntitlement.PatientEmployment.Employer != null )
            {
                msg.Append( disabilityEntitlement.PatientEmployment.Employer.Name );
            }
        ...
        private void ConfigureControls()
        {
            ...
            lblQ1EmployerInfo.TextChanged += runRules;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager( typeof( ShortDisabilityEntitlementPage1 ) );
            ...
            // 
            // ShortDisabilityEntitlementPage1
            // 
            this.Name = "ShortDisabilityEntitlementPage1";
        ...
        public ShortDisabilityEntitlementPage1()
        {
        ...
        public ShortDisabilityEntitlementPage1( WizardContainer wizardContainer )
        ...
        public ShortDisabilityEntitlementPage1( string pageName, WizardContainer wizardContainer )
        ...
        public ShortDisabilityEntitlementPage1( string pageName, WizardContainer wizardContainer, Account anAccount )
