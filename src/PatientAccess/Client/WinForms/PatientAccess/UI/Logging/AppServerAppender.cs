...
#region log4net Copyright & License
//
// This module was adapted from a lo4net source module RemotingAppender.cs
// in the incubating-log4net-1.2.9-beta release.
//
// cash.foley@ps.net
//
...
//
#region http://www.apache.org/licenses/LICENSE-2.0
//Apache License
...
namespace PatientAccess.UI.Logging
{
    ...
    public class AppServerAppender : BufferingAppenderSkeleton
    {
        #region Methods
        #endregion
        ...
        /// infrastructure will flow thread local variables (stored in the <see cref="System.Runtime.Remoting.Messaging.CallContext"/>),
        /// if they are marked as <see cref="System.Runtime.Remoting.Messaging.ILogicalThreadAffinative"/>, across the 
        ...
        /// the remoting infrastructure will clear the <see cref="System.Runtime.Remoting.Messaging.ILogicalThreadAffinative"/>
        /// objects from the <see cref="System.Runtime.Remoting.Messaging.CallContext"/>. To prevent a logging failure from
        ...
        private ILoggerBroker LoggerBroker
        {
            get
            {
                return i_LoggerBroker;
            }
        }
        #endregion

        #region Construction and Finalization
        public AppServerAppender()
        {
            i_LoggerBroker = BrokerFactory.BrokerOfType<ILoggerBroker>();
        }
        #endregion
        ...
        private readonly ILoggerBroker i_LoggerBroker;
