...
{
    internal class PAIWalkinAccountCreationPresenter : IPAIWalkinAccountCreationPresenter
    {
        #region Constructors

        internal PAIWalkinAccountCreationPresenter( IPAIWalkinAccountCreationView view, IMessageBoxAdapter messageBoxAdapter, Account modelAccount, IRuleEngine ruleEngine )
        {
            View = view;
        ...
        private IPAIWalkinAccountCreationView View { get; set; }
        ...
        public void UpdateView()
        {
            PopulateFirstName();
            PopulateLastName();
            PopulateMiddleInitial();
            PopulateScheduleCodeComboBox();            
            SetScheduleCode();
            HandleProcedureField();
            HandleChiefComplaintField();
            SetAdmitDateOnUIFromTheModel();
            SetAdmitTimeOnUIFromTheModel();
            SetDateOfBirthAndAge();
            
            if (!PopulateDateOfBirth())
            {
                View.SetDateOfBirthErrBgColor();
            }
            
            UpdateAdmitDateUnaltered();
        }
        ...
        public void UpdateProcedureField( string procedureText )
        {
            View.ModelAccount.Diagnosis.Procedure = procedureText;
            RuleEngine.EvaluateRule( typeof( ProcedureRequired ), View.ModelAccount );
        }
        public void UpdateChiefComplaintField( string complaintText )
        {
            View.ModelAccount.Diagnosis.ChiefComplaint = complaintText;
            RuleEngine.EvaluateRule( typeof( ChiefComplaintRequired ), View.ModelAccount );
        }
        ...
        /// </summary>
        private void HandleChiefComplaintField()
        {
            View.PopulateChiefComplaint();
            RuleEngine.EvaluateRule( typeof( ChiefComplaintRequired ), View.ModelAccount );
        }

        private void HandleProcedureField()
        {
            View.PopulateProcedure();
            RuleEngine.EvaluateRule( typeof( ProcedureRequired ), View.ModelAccount );
        }
        ...
        private void UpdateAdmitDateUnaltered()
        {
        ...
        private void PopulateMiddleInitial()
        {
