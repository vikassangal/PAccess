...
{
    internal class PAIWalkinInsurancePresenter : IPAIWalkinInsurancePresenter
    {
        #region Constructors

        internal PAIWalkinInsurancePresenter( IPAIWalkinInsuranceView view, Account modelAccount, IRuleEngine ruleEngine )
        {
            View = view;
        ...
        private IPAIWalkinInsuranceView View { get; set; }
        ...
        public void Edit()
        {
            ...
            try
            {
                ...
                if ( View.InsuranceDetailsDialog.ShowDialog( (PAIWalkinInsuranceView)View ) == DialogResult.OK )
                {
                    UpdateView();
                }
