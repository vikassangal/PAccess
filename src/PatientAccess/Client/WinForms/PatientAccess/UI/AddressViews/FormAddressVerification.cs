...
namespace PatientAccess.UI.AddressViews
{
    ...
    /// </summary>
    [Serializable]
    public class FormAddressVerification : TimeOutFormView
    {
        ...
        private void cbxIgnore_Click( object sender, EventArgs e )
        {
			...
			this.btnOk.Location = new Point( 319,364 );
			this.btnCancelEdit.Location = new Point( 399,364 );
        }
...
//						( addressValidation.Address1.Length > 0 && addressValidation.Address1.Length <= 25 ) ) )
        ...
        protected virtual AddressEntryView TheAddressView
        {
            get
            {
                return new AddressEntryView( this.Facility, this.RuleEngine);
            }
        }
        ...
        {
            if( address != null &&
                address.Address1.Length + address.Address2.Length > 25 || 
        ...
        {   
            ...
            if( !AddressLengthIsValid(selectedAddress) )
            {
                ...
                this.btnOk.Location = new Point( 319,541 );
				this.btnCancelEdit.Location = new Point( 399,541 );
                this.AcceptButton = this.addressEntryView1.btnVerify;
		...
		private void InitializeComponent()
		{
            ...
            this.addressEntryView1.Size = new Size(466, 188);
            ...
            this.panel1.Size = new Size(467, 185);
            ...
            this.btnOk.Location = new Point(314, 534);
            ...
            this.btnCancelEdit.Location = new Point(394, 534);
            ...
            this.panel2.Location = new Point(6, 200);
            ...
            this.panel3.Location = new Point(6, 368);
            ...
            this.ClientSize = new Size(479, 558);
        ...
        private AddressEntryView addressEntryView1;
        ...
        public FormAddressVerification()
        {
        ...
        public FormAddressVerification(Facility facility, RuleEngine ruleEngine)
        {
            Facility = facility;
